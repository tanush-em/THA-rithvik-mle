...
source_url: "https://support.devplatform.com/articles/1626384486-hidden-test-cases-for-front-end%2C-back-end-and-full-stack-questions"
...
DevPlatform Tests allows you to hide your test cases for the Front end, Back End, and Full Stack question types. This article will walk you through the process of adding Hidden Test Cases to your project file.  

## Steps to Add Hidden Test Cases

- In the “Setup Project” step of question creation, you can add test case files you intend to hide from the candidate inside the project and declare its path inside the DevPlatform.yml file.
