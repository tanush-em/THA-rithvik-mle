...
source_url: "https://support.devplatform.com/articles/9443018671-configurations-for-front-end%2C-back-end-and-full-stack-developer-questions"
...
A valid project should have a valid **devplatform.yml** configuration file in the root directory. Refer to the examples below or the configuration reference to learn how to write one for your project. 
...
version: 1.0configuration:has_webserver: falsescoring:
    ...
    default_open_files:
      - src/main/java/com/devplatform/sample/controller/ModelController.java
      - src/main/java/com/devplatform/sample/model/Model.java
    project_menu: 
