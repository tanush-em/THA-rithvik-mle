...
source_url: "https://support.devplatform.com/articles/1053996435-validating-a-project-for-front-end%2C-back-end%2C-and-full-stack-questions"
...
Before you import a project in a 'DevPlatform Projects' question (front-end developer, back-end developer or both), you should ensure it is valid. A valid project should have the following:

1.  The project must be less than **5 MB** in size.

2.  A **devplatform.yml** configuration file in the root directory.

3.  The configuration should have all the required parameters. Follow [📄 Configurations for Front-end, Back-end and Full stack Developer Questions](/articles/9443018671)to learn about writing a valid devplatform.yml file.
...
2.  Verify that devplatform.yml is present in the root directory of the project.

3.  Validate devplatform.yml for correct format and required values
