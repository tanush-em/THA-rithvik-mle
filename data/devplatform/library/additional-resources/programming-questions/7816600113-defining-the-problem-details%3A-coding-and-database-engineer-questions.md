...
title_slug: "defining-the-problem-details-coding-and-database-engineer-questions"
source_url: "https://support.devplatform.com/articles/7816600113-defining-the-problem-details%3A-coding-and-database-engineer-questions"
article_slug: "7816600113-defining-the-problem-details%3A-coding-and-database-engineer-questions"
last_updated_exact: "Dec 24, 2024, 4:33 AM"
...
# Defining the Problem Details: Coding and Database Engineer Questions

_Last updated: Dec 24, 2024, 4:33 AM (Last updated 1 year ago)_
...
DevPlatform for Work simplifies this process with predefined templates to describe your **Coding** and **Database Engineer** type questions. The templates are a simple and structured format to define your questions clearly.  
...
<tbody>
<tr>
<td data-colspan="1" data-rowspan="1" style="background-color: #eafcef"><p><strong>Template </strong></p></td>
<td data-colspan="1" data-rowspan="1" style="background-color: #eafcef"><p><strong>Description</strong></p></td>
</tr>
<tr>
<td data-colspan="1" data-rowspan="1" style="width: 309.83px"><p>DevPlatform's Coding Question Template</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 310.739px"><p>Recommended for coding-type questions. Provides the format to define the:</p>
<ul>
<li><p>problem statement</p></li>
<li><p>function</p></li>
<li><p>constraints</p></li>
<li><p>sample input values</p></li>
<li><p>sample output values</p></li>
</ul></td>
</tr>
<tr>
<td data-colspan="1" data-rowspan="1" style="width: 309.83px"><p>DevPlatform's Database Question Template</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 310.739px"><p>Recommended for Database Engineer-type questions. Provides the format to define the:</p>
<ul>
<li><p>problem description with any database queries</p></li>
<li><p>the database tables schema </p></li>
<li><p>the input using the sample table schema</p></li>
<li><p>the output values</p></li>
</ul></td>
</tr>
</tbody>
</table>
...
1.  You can select the required template based on your question type. The template format is added to your **Problem description** area.

2.  Detail the question as per the format.
...
*A coding question description using a coding template*
...
<tbody>
<tr>
<td data-colspan="1" data-rowspan="1" style="width: 733.466px"><p><strong>Problem Description</strong></p>
...
<p>Explanation</p>
<ul>
<li><p>"a" is the first character that is not repeated in the given string.</p></li>
</ul>
<p><strong>Output Format</strong></p>
<p>A single character that represents the first character in <em>Str</em> that is not repeated.</p></td>
</tr>
</tbody>
</table>
...
1.  Sample Test Case with Explanation
