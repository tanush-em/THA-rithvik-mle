...
source_url: "https://support.devplatform.com/articles/9502641162-q3%27-23-release-notes"
...
DevPlatform continually enhances its platform with improvements and fixes to serve you better. We’ve rolled out a series of new improvements and fixes this October 2023. On request, our team is ready to assist you with the required change management. Please contact us at support@devplatform.com if you have any questions.
...
Visit the [Centralized Test Settings](https://support.devplatform.com/hc/en-us/articles/22181498897683-Centralized-Test-Settings) article to learn more.
...
Visit the [Teams Management](https://support.devplatform.com/hc/en-us/articles/22181635545875-Teams-Management) article to learn more.
...
Visit the [Disabling Implicit Sharing](https://support.devplatform.com/hc/en-us/articles/22181705964179-Disabling-Implicit-Sharing) article to learn more.

## Integrations

### Logs for ATS Integrations

You will soon have the ability to view a record of integration activity between DevPlatform and your ATS in the DevPlatform platform. You will be able to get log results for a custom date range for any ATS integrated with your DevPlatform instance and download a PDF report.

For instance, if you want to see why something might not have synced correctly with your ATS from DevPlatform, you can view a detailed log of the error with a timestamp and summary. 
...
Visit the [Integration Logs](https://support.devplatform.com/hc/en-us/articles/21774549534867-Integration-Logs) article to learn more.

### Enhanced Integration With iCIMS 

The iCIMS integration with DevPlatform has been revamped with improved performance and greater functionality. For example, if you want to assign DevPlatform tests and receive results without leaving your ATS, you can do so within iCIMS. This enhanced functionality enables you to do more without having to switch between DevPlatform and iCIMS. 

Visit the [iCIMS - DevPlatform Integration Guide](https://support.devplatform.com/hc/en-us/articles/11720157490835-iCIMS-DevPlatform-Integration-Guide) to learn more.
...
Visit the [Summary Reports](https://support.devplatform.com/hc/en-us/articles/4408913281427-Viewing-a-Candidate-s-Test-Summary-Report) article to learn more.
