---
title: "DevPlatform Dataset Creation Methodology"
title_slug: "devplatform-dataset-creation-methodology"
source_url: "https://support.devplatform.com/articles/4425890244-devplatform-dataset-creation-methodology"
article_slug: "4425890244-devplatform-dataset-creation-methodology"
last_updated_exact: "Jun 23, 2025, 7:29 PM"
last_updated_relative: "Last updated 10 months ago"
breadcrumbs:
  - "General Help"
  - "DevPlatform AI Data Services"
---

# DevPlatform Dataset Creation Methodology

_Last updated: Jun 23, 2025, 7:29 PM (Last updated 10 months ago)_

This document explains how DevPlatform designs, builds, and delivers datasets across the SDLC to help customers accelerate software development. 

The workflow diagram below illustrates the DevPlatform Dataset Creation Methodology.
...
Each engagement starts with a focus on understanding your business context, technical goals, data requirements, and security constraints. This ensures that DevPlatform is fully aligned before any project work starts.
...
- **Use case definition:** DevPlatform’s machine learning (ML) scientists collaborate with your team to define the specific capability you want to improve, such as:
...
By defining key performance indicators (KPIs) and model behavior targets, DevPlatform aligns downstream decisions—such as task selection and evaluation format—with your business priorities.
...
DevPlatform adheres to industry-standard [data privacy and security practices](https://www.devplatform.com/trust/security/). During project kickoff, DevPlatform finalizes your security and compliance requirements.
...
DevPlatform sets up a shared communication channels (Slack or email) and an optional shared drive for real-time updates and status reports.

## Dataset preparation

DevPlatform’s core strength lies in a global network of highly vetted subject-matter experts (SMEs) and a proven methodology to create production-grade, diverse code datasets. The process integrates domain expertise, structured workflows, and multi-layered quality assurance to ensure that every data point is accurate, explainable, and aligned with your goals.
...
- **Benchmarks:** Model performance is evaluated using:
  ...
  - DevPlatform’s ASTRA benchmark, customized for your use case
...
If no suitable public benchmark exists for a task (for example, domain-specific language, refactoring), DevPlatform will co-design a custom evaluation suite with the customer to ensure meaningful evaluation.
...
- Manually evaluated gold labels from DevPlatform SMEs
...
After a dataset passes all quality checks and receives required approvals, DevPlatform initiates a secure and verifiable delivery process. The delivery workflow is designed for traceability, reproducibility, and seamless integration with ML pipelines.
...
DevPlatform supports multiple secure, enterprise-compliant delivery channels:
...
Upon request, DevPlatform provides a walkthrough session with your team to:
...
- DevPlatform retains a copy of the dataset and delivery logs for 30 to 90 days (configurable).
