...
## Chakra / Integrations
- [Ashby - Chakra Integration User Guide Prerequisites Adding an AI Interviewer activity in Ashby Scheduling DevPlatform AI Interview from Ashby Viewing Interview results](chakra/integrations/8472393759-ashby-chakra-integration-user-guide.md)
...
- [DevPlatform Engage - Marketing Best Practices](engage/7196095057-devplatform-engage---marketing-best-practices.md)
- [Introduction to DevPlatform Engage](engage/6424218208-devplatform-engage.md)
...
- [DevPlatform Academy](general-help/academy/5297005851-devplatform-academy-video-tutorial.md)
...
- [Ensuring a Great Candidate Experience Prepare candidates for success How DevPlatform manages candidate support Recommended candidate support workflow](general-help/additional-resources/6477583642-ensuring-a-great-candidate-experience.md)
...
- [Contact DevPlatform Support](general-help/contact-us/8616956464-contact-devplatform-support.md)
- [Meet DevPlatform’s Solution Engineering team](general-help/contact-us/5656446182-our-devplatform%E2%80%99s-solution-engineering-team.md)
...
## General Help / DevPlatform AI
- [DevPlatform AI Add-on See What’s Included](general-help/devplatform-ai/5847651809-devplatform-ai-add-ons.md)
- [DevPlatform's AI Features](general-help/devplatform-ai/9416207922-devplatform%27s-ai-features.md)
## General Help / DevPlatform AI Data Services
- [DevPlatform AI Data Services FAQ](general-help/devplatform-ai-data-services/2212135172-devplatform-ai-data-services-faq.md)
- [DevPlatform Dataset Creation Methodology](general-help/devplatform-ai-data-services/4425890244-devplatform-dataset-creation-methodology.md)
## General Help / Important Notifications
- [DevPlatform Maintenance Window Notification Maintenance schedule Impact Required actions Frequently Asked Questions Need support?](general-help/important-notifications/2086891729-devplatform-maintenance-window-notification.md)
...
- [What's New on DevPlatform](general-help/release-notes/5026442259-what%27s-new-on-devplatform-.md)
## Integrations / Applicant Tracking Systems
- [Rooster - DevPlatform integration](integrations/applicant-tracking-systems/5902644770-rooster-devplatform-integration.md)
## Integrations / Applicant Tracking Systems / Ashby
- [Ashby - DevPlatform Integration Configuration Guide](integrations/applicant-tracking-systems/ashby/4146164514-ashby---devplatform-integration-configuration-guide.md)
- [Ashby - DevPlatform Integration User Guide](integrations/applicant-tracking-systems/ashby/5999209869-ashby---devplatform-integration-user-guide.md)
- [Ashby - DevPlatform Technical Interview Integration Guide](integrations/applicant-tracking-systems/ashby/7862793608-ashby-devplatform-technical-interview-integration-guide.md)
- [Ashby Integration with DevPlatform](integrations/applicant-tracking-systems/ashby/9896080715-ashby-integration-with-devplatform.md)
## Integrations / Applicant Tracking Systems / Avature
- [Avature - DevPlatform Integration Avature Integration features](integrations/applicant-tracking-systems/avature/7339966937-avature---devplatform-integration.md)
## Integrations / Applicant Tracking Systems / Breezy
- [Breezy - DevPlatform Integration Setup](integrations/applicant-tracking-systems/breezy/6794716414-breezy---devplatform-integration-setup.md)
## Integrations / Applicant Tracking Systems / Darwinbox
- [Darwinbox - DevPlatform Integration Guide](integrations/applicant-tracking-systems/darwinbox/2001883323-darwinbox---devplatform-integration-guide.md)
## Integrations / Applicant Tracking Systems / Eightfold
- [Eightfold - DevPlatform Integration](integrations/applicant-tracking-systems/eightfold/7924497743-eightfold---devplatform-integration.md)
- [Eightfold - DevPlatform Integration User Guide Overview](integrations/applicant-tracking-systems/eightfold/2155086316-devplatform---eightfold-integration-user-guide.md)
- [DevPlatform - Eightfold Integration Configuration Guide](integrations/applicant-tracking-systems/eightfold/2732992835-devplatform---eightfold-integration-configuration-guide.md)
## Integrations / Applicant Tracking Systems / Freshteam
- [Freshteam - DevPlatform Integration Guide](integrations/applicant-tracking-systems/freshteam/9978423020-freshteam---devplatform-integration-guide.md)
...
- [Greenhouse - DevPlatform Integration Guide Prerequisites Integrating Greenhouse with DevPlatform Glossary Frequently Asked Questions (FAQs)](integrations/applicant-tracking-systems/greenhouse/1406188460-greenhouse---devplatform-integration-guide.md)
- [Greenhouse - DevPlatform Integration Interview User Guide Prerequisites Adding DevPlatform interview stage in Greenhouse Scheduling DevPlatform Interview Viewing Interview Results](integrations/applicant-tracking-systems/greenhouse/8806262569-greenhouse---devplatform-integration-interviews-user-guide.md)
- [Greenhouse - DevPlatform Integration Overview](integrations/applicant-tracking-systems/greenhouse/2646010908-greenhouse---devplatform-integration-overview.md)
- [Greenhouse - DevPlatform Integration Test User Guide Prerequisites Adding DevPlatform assessment stage in Greenhouse Sending DevPlatform test invite to a candidate Sending bulk DevPlatform test invites to candidates Viewing candidate test results Viewing updated scores in Greenhouse](integrations/applicant-tracking-systems/greenhouse/2499611070-greenhouse---devplatform-integration-tests-user-guide-.md)
- [Greenhouse-DevPlatform Integration FAQs API Token and Access Tests and Interviews Common Troubleshooting](integrations/applicant-tracking-systems/greenhouse/3678461564-greenhouse-devplatform-integration-faqs.md)
## Integrations / Applicant Tracking Systems / IBM Kenexa Brassring
- [IBM Kenexa BrassRing - DevPlatform Integration](integrations/applicant-tracking-systems/ibm-kenexa-brassring/7600349400-ibm-kenexa-brassring---devplatform-integration.md)
- [IBM Kenexa BrassRing - DevPlatform Tests Integration](integrations/applicant-tracking-systems/ibm-kenexa-brassring/7795424803-ibm-kenexa-brassring---devplatform-tests-integration.md)
...
- [iCIMS - DevPlatform Integration Guide](integrations/applicant-tracking-systems/icims/9631673147-icims---devplatform-integration-guide.md)
- [iCIMS - DevPlatform Prime Assessments Configuration Guide](integrations/applicant-tracking-systems/icims/2481948575-icims---devplatform-prime-assessments-configuration-guide.md)
- [iCIMS - DevPlatform Prime Assessments Integration Guide](integrations/applicant-tracking-systems/icims/4539361473-icims---devplatform-prime-assessments-integration-guide.md)
- [iCIMS Prime Assessment - DevPlatform Integration User Guide](integrations/applicant-tracking-systems/icims/1495212030-icims-prime-assessment---devplatform-integration-user-guide.md)
## Integrations / Applicant Tracking Systems / Jazz
- [Jazz - DevPlatform Tests integration](integrations/applicant-tracking-systems/jazz/5164370576-jazz---devplatform-tests-integration.md)
## Integrations / Applicant Tracking Systems / Jobvite
- [Jobvite - DevPlatform Integration](integrations/applicant-tracking-systems/jobvite/6917918087-jobvite---devplatform-integration.md)
- [Jobvite - DevPlatform Integration Configuration Guide](integrations/applicant-tracking-systems/jobvite/1202195004-jobvite---devplatform-integration-configuration-guide.md)
- [Jobvite - DevPlatform Integration User Guide](integrations/applicant-tracking-systems/jobvite/2429924508-jobvite---devplatform-integration-user-guide.md)
## Integrations / Applicant Tracking Systems / Kula.ai
- [Kula.ai – DevPlatform Integration User Guide Prerequisites Integrating Kula.ai with DevPlatform Managing integration](integrations/applicant-tracking-systems/kulaai/5121238837-kula-ai-devplatform-integration-user-guide.md)
...
- [Lever - DevPlatform Interview Integration Overview Lever - DevPlatform Interview Integration](integrations/applicant-tracking-systems/lever/8274807044-lever---devplatform-interview-integration.md)
- [Lever - DevPlatform Tests Integration](integrations/applicant-tracking-systems/lever/7177093032-lever---devplatform-tests-integration.md)
- [Lever DevPlatform Integration](integrations/applicant-tracking-systems/lever/1538275190-lever-devplatform-integration.md)
- [Scheduling DevPlatform Interviews with Candidates in Lever](integrations/applicant-tracking-systems/lever/2634152447-scheduling-devplatform-interviews-with-candidates-in-lever.md)
## Integrations / Applicant Tracking Systems / Lever V2
- [Lever V2 - DevPlatform Integration Guide Prerequisites Integrating Lever V2 for DevPlatform tests Integrating Lever V2 for DevPlatform interviews](integrations/applicant-tracking-systems/lever-v2/5647291926-lever-v2-devplatform-integration-guide.md)
- [Lever V2 - DevPlatform Integration Interview User Guide Prerequisites Scheduling a DevPlatform interview from Lever Viewing Interview feedback in Lever](integrations/applicant-tracking-systems/lever-v2/5269579148-lever-v2-devplatform-integration-interview-user-guide.md)
- [Lever V2 - DevPlatform Integration Test User Guide Prerequisites Inviting candidates to a DevPlatform test Viewing test results in Lever](integrations/applicant-tracking-systems/lever-v2/6548604920-lever-v2-devplatform-integration-test-user-guide.md)
## Integrations / Applicant Tracking Systems / Linkedin Talent Hub
- [LinkedIn Talent Hub - DevPlatform Integration](integrations/applicant-tracking-systems/linkedin-talent-hub/2757478179-linkedin-talent-hub---devplatform-integration-.md)
## Integrations / Applicant Tracking Systems / ModernLoop
- [ModernLoop - DevPlatform Integration User Guide Prerequisites Integrating ModernLoop with DevPlatform Using DevPlatform integration](integrations/applicant-tracking-systems/modernloop/9797503689-modernloop-devplatform-integration-user-guide.md)
## Integrations / Applicant Tracking Systems / Northstarz
- [Northstarz - DevPlatform Integration User Guide Adding DevPlatform test to a job on Northstarz Sending DevPlatform test invites from Northstarz Viewing a candidate test report on Northstarz](integrations/applicant-tracking-systems/northstarz/4546750166-northstarz-devplatform-integration-user-guide.md)
## Integrations / Applicant Tracking Systems / Oracle Recruiting Cloud
- [Oracle Recruiting Cloud - DevPlatform Integration](integrations/applicant-tracking-systems/oracle-recruiting-cloud/8503244016-oracle-recruiting-cloud---devplatform-integration-.md)
- [Oracle Recruiting Cloud - DevPlatform Integration Setup Guide](integrations/applicant-tracking-systems/oracle-recruiting-cloud/8672148210-oracle-recruiting-cloud---devplatform-integration-setup-guide.md)
- [Oracle Recruiting Cloud and DevPlatform Integration User Guide](integrations/applicant-tracking-systems/oracle-recruiting-cloud/3350882088-oracle-recruiting-cloud-and-devplatform-integration-user-guide.md)
## Integrations / Applicant Tracking Systems / Phenom People
- [Phenom People - DevPlatform Integration Guide](integrations/applicant-tracking-systems/phenom-people/7288417717-phenom-people---devplatform-integration-guide.md)
## Integrations / Applicant Tracking Systems / Prismforce
- [Prismforce - DevPlatform Integration Guide](integrations/applicant-tracking-systems/prismforce/5932438086-prismforce---devplatform-integration-guide.md)
## Integrations / Applicant Tracking Systems / Recruitee
- [Recruitee - DevPlatform Integration Guide Prerequisites Integrating Recruitee with DevPlatform](integrations/applicant-tracking-systems/recruitee/1039021982-recruitee-devplatform-integration-guide.md)
- [Recruitee - DevPlatform Integration Interview User Guide Prerequisites Inviting candidates to a DevPlatform interview Viewing interview results](integrations/applicant-tracking-systems/recruitee/7457838560-recruitee-devplatform-integration-interview-user-guide.md)
- [Recruitee - DevPlatform Integration Overview Tests features](integrations/applicant-tracking-systems/recruitee/6130823390-recruitee---devplatform-integration-guide.md)
- [Recruitee - DevPlatform Integration Test User Guide Prerequisites Inviting candidates to a DevPlatform test Viewing test results](integrations/applicant-tracking-systems/recruitee/4110238052-recruitee-devplatform-integration-test-user-guide.md)
...
- [SAP Success Factors - DevPlatform Integration Guide](integrations/applicant-tracking-systems/sap-success-factors/6922485557-sap-success-factors---devplatform-integration-guide.md)
## Integrations / Applicant Tracking Systems / SmartRecruiters
- [SmartRecruiters - DevPlatform Integration](integrations/applicant-tracking-systems/smartrecruiters/9231210914-smartrecruiters---devplatform-integration.md)
- [SmartRecruiters - DevPlatform Integration Configuration Guide](integrations/applicant-tracking-systems/smartrecruiters/5934100296-smartrecruiters---devplatform-integration-configuration-guide.md)
- [SmartRecruiters - DevPlatform Integration User Guide](integrations/applicant-tracking-systems/smartrecruiters/2880884436-smartrecruiters---devplatform-integration-user-guide.md)
...
- [Teamtailor - DevPlatform Integration](integrations/applicant-tracking-systems/teamtailor/9251533406-teamtailor---devplatform-integration.md)
- [Teamtailor - DevPlatform Integration Configuration Guide](integrations/applicant-tracking-systems/teamtailor/3927772988-teamtailor---devplatform-integration-configuration-guide.md)
- [Teamtailor - DevPlatform Integration: User Guide](integrations/applicant-tracking-systems/teamtailor/6599779249-teamtailor---devplatform-integration%3A-user-guide.md)
## Integrations / Applicant Tracking Systems / Workable
- [Workable - DevPlatform Tests Integration](integrations/applicant-tracking-systems/workable/3863699223-workable---devplatform-tests-integration.md)
## Integrations / Applicant Tracking Systems / Workday
- [Workday - DevPlatform Integration](integrations/applicant-tracking-systems/workday/3252953266-workday---devplatform-integration.md)
- [Workday - DevPlatform Interviews Configuration Guide](integrations/applicant-tracking-systems/workday/4722432610-workday---devplatform-interviews-configuration-guide.md)
- [Workday - DevPlatform Interviews User Guide Prerequisites Schedule Interviews on Workday View the Interview Scorecard in Workday](integrations/applicant-tracking-systems/workday/7842363172-workday---devplatform-interviews-user-guide.md)
- [Workday - DevPlatform Tests Configuration Guide](integrations/applicant-tracking-systems/workday/1782819445-workday---devplatform-tests-configuration-guide.md)
- [Workday - DevPlatform Tests User Guide](integrations/applicant-tracking-systems/workday/1999755553-workday---devplatform-tests-user-guide.md)
## Integrations / Applicant Tracking Systems / Zapier
- [Zapier - DevPlatform Integration Guide Prerequisites Integrating Zapier with DevPlatform](integrations/applicant-tracking-systems/zapier/9883166979-zapier-devplatform-integration-guide.md)
- [Zapier - DevPlatform Integration Interview User Guide Prerequisites Configuring Zaps for DevPlatform interviews Sending interview invites Viewing interview results](integrations/applicant-tracking-systems/zapier/5179178131-zapier-devplatform-integration-interview-user-guide.md)
- [Zapier - DevPlatform Integration Test User Guide Prerequisites Configuring Zaps for DevPlatform assessments Sending assessment invites Viewing assessment results](integrations/applicant-tracking-systems/zapier/7100809601-zapier-devplatform-integration-test-user-guide.md)
## Integrations / Applicant Tracking Systems / Zoho Recruit
- [Zoho Recruit - DevPlatform Integration](integrations/applicant-tracking-systems/zoho-recruit/6202373438-zoho-recruit---devplatform-integration.md)
- [Zoho Recruit - DevPlatform Integration Setup](integrations/applicant-tracking-systems/zoho-recruit/8020207036-zoho-recruit---devplatform-integration-setup.md)
- [Zoho Recruit - Sending DevPlatform Tests and Interviews](integrations/applicant-tracking-systems/zoho-recruit/3696308525-zoho-recruit---sending-devplatform-tests-and-interviews.md)
...
- [Partner Guide to building an integration with DevPlatform](integrations/getting-started-with-integrations/8660206242-partner-guide-to-building-an-integration-with-devplatform.md)
## Integrations / Productivity
- [Interview Vector - DevPlatform Integration Guide](integrations/productivity/6541817100-interview-vector---devplatform-integration-guide.md)
- [Slack - DevPlatform Integration Guide](integrations/productivity/1480104967-slack---devplatform-integration-guide.md)
- [Splash - DevPlatform Integration Guide](integrations/productivity/1979161599-splash---devplatform-integration-guide.md)
## Integrations / Scheduling
- [Calendar Add-ons for DevPlatform Interviews](integrations/scheduling/3450462093-calendar-add-ons-for-devplatform-interviews.md)
- [Configuring InterviewPlanner - DevPlatform Integration](integrations/scheduling/1300810624-configuring-interviewplanner---devplatform-integration.md)
- [Goodtime - DevPlatform Integration Guide](integrations/scheduling/7205562153-goodtime---devplatform-integration-guide.md)
- [DevPlatform Interview and Google Calendar Integration](integrations/scheduling/1262999130-devplatform-interview-and-google-calendar-integration.md)
- [DevPlatform Interview and Outlook Calendar Integration](integrations/scheduling/2480863637-devplatform-interview-and-outlook-calendar-integration.md)
- [InterviewPlanner - DevPlatform Integration](integrations/scheduling/6566949282-interviewplanner---devplatform-integration.md)
- [InterviewPlanner-DevPlatform Integration FAQs](integrations/scheduling/7401637722-interviewplanner-devplatform-integration-faqs-.md)
- [Prelude - DevPlatform Integration Guide](integrations/scheduling/6684042810-prelude---devplatform-integration-guide.md)
- [Using DevPlatform Interviews in InterviewPlanner](integrations/scheduling/3675175160-using-devplatform-interviews-in-interviewplanner.md)
...
- [Just-in-Time (JIT) Provisioning for DevPlatform SSO](integrations/single-sign-on-sso/8000473667--setting-up-devplatform-sso-with-just-in-time-.md)
- [Log In to DevPlatform with Google Workspace Account](integrations/single-sign-on-sso/9826965692-log-in-to-devplatform-with-google-workspace-account.md)
- [SAML 2.0 Single Sign-on (SSO)](integrations/single-sign-on-sso/4516079405-saml-2.0-single-sign-on-%28sso%29-.md)
- [Set up DevPlatform Single Sign-On with Okta Prerequisites Setting up DevPlatform Single Sign-On with Okta](integrations/single-sign-on-sso/2841246365-setting-up-devplatform-single-sign-on-with-okta.md)
- [Setting up DevPlatform Single Sign-On with Azure AD](integrations/single-sign-on-sso/3007497492-setting-up-devplatform-single-sign-on-with-azure-ad.md)
- [Setting Up DevPlatform SSO with OneLogin](integrations/single-sign-on-sso/6114369280-setting-up-devplatform-sso-with-onelogin.md)
...
- [DevPlatform Interview Best Practices](interviews/additional-resources/5533854049-devplatform-interview-best-practices.md)
...
- [Introduction to DevPlatform Interviews](interviews/getting-started/9059560249-introduction-to-devplatform-interviews.md)
- [Network Monitoring in DevPlatform Interviews](interviews/getting-started/6375174017-network-monitoring-in-devplatform-interviews.md)
- [Question Types in DevPlatform Interviews](interviews/getting-started/9999244916-question-types-in-devplatform-interviews.md)
...
- [Webex - DevPlatform Interview Integration](interviews/integrations/7623780280-webex---devplatform-interview-integration.md)
- [Zoom - DevPlatform Interview Integration](interviews/integrations/5805684780-zoom---devplatform-interview-integration.md)
...
- [Using Virtual Lobby in DevPlatform Interviews](interviews/interview-settings/1151935613-using-virtual-lobby-in-devplatform-interviews.md)
...
- [Data Science Projects in DevPlatform Interviews](interviews/manage-interviews/3087722674-data-science-projects-in-devplatform-interviews.md)
...
- [DevOps Questions in DevPlatform Interviews](interviews/manage-interviews/8182862423-devops-questions-in-devplatform-interviews.md)
...
- [Front-End Questions in DevPlatform Interviews](interviews/manage-interviews/7721811663-front-end-questions-in-devplatform-interviews.md)
...
- [Importing Projects in DevPlatform Interview](interviews/manage-interviews/1769104522-importing-projects-in-devplatform-interview-.md)
...
- [How can I edit DevPlatform Library Questions?](library/frequently-asked-questions/7502854057-can-i-edit-devplatform-library-questions%3F.md)
## Library / Getting Started
- [DevPlatform Question Count Comparison by Subscription Plan](library/getting-started/6095274436-devplatform-question-count-comparison-by-subscription-plan.md)
- [Introduction to DevPlatform Library Accessing the Library Question sources Searching, sorting, and filtering questions Related topics](library/getting-started/5664166353-devplatform-library-navigation.md)
- [Question Types in DevPlatform Supported question types](library/getting-started/2354192461-question-types-in-devplatform-tests.md)
...
- [Steps to Create Accessible Content at DevPlatform](library/manage-question/4968606472-steps-to-create-accessible-content-at-devplatform.md)
...
- [How to Assess Data Engineering Skills on DevPlatform?](screen/frequently-asked-questions/1572498839-how-to-assess-data-engineering-skills-on-devplatform%3F.md)
- [How to Assess Kubernetes Skills on DevPlatform](screen/frequently-asked-questions/8730911957-how-to-assess-kubernetes-skills-on-devplatform.md)
- [How to Assess Machine Learning Engineering Skills on DevPlatform?](screen/frequently-asked-questions/2229796182-how-to-assess-machine-learning-engineering-skills-on-devplatform%3F.md)
- [How to Assess Selenium Skills of a Candidate on DevPlatform?](screen/frequently-asked-questions/4357184721-how-to-assess-selenium-skills-of-a-candidate-on-devplatform.md)
...
- [DevPlatform Certified Assessments](screen/getting-started/1649328687-devplatform-certified-assessments.md)
- [DevPlatform Glossary](screen/getting-started/3572240492-devplatform-glossary.md)
...
- [Limitations With DevPlatform Projects](screen/invite-candidates/3052727240-limitations-with-devplatform-projects.md)
...
- [Best Practices for Running Group Assessments in DevPlatform Desktop App Mode Prepare candidate systems in advance Ensure a stable internet connection Set up webcams Set up lighting Prepare the physical environment Complete pre-test setup Troubleshooting](screen/test-integrity/2686193421-best-practices-for-running-group-assessments-in-devplatform-desktop-app-mode.md)
...
- [DevPlatform Desktop App Mode Enable DevPlatform Desktop App Mode How DevPlatform Desktop App Mode works](screen/test-integrity/5973590014-devplatform-desktop-app-mode.md)
- [DevPlatform Test Integrity Test Integrity Modes Additional integrity features Built-in integrity features](screen/test-integrity/1079706165-proctoring-devplatform-tests.md)
...
- [View Candidates List for a Test Viewing the candidates list](screen/test-reports/9135272973-candidates-list-in-devplatform-tests.md)
...
- [Enhancing your Account Security on DevPlatform for Work](settings/company-level-admin-settings/7425207053-enhancing-your-account-security-on-devplatform-for-work.md)
...
- [GDPR FAQs for DevPlatform for Work](settings/gdpr-and-nyc-ai-laws/2634495557-gdpr-faqs-for-devplatform-for-work.md)
- [DevPlatform Services and AI Laws FAQs](settings/gdpr-and-nyc-ai-laws/3067349942-faqs%3A--devplatform-services-and-ai-laws.md)
- [Summary of Bias Audit Results (DevPlatform's Image Analysis System)](settings/gdpr-and-nyc-ai-laws/8514725302-summary-of-bias-audit-results-%28devplatform%27s-image-analysis-system%29.md)
- [Summary of Bias Audit Results of the DevPlatform's Plagiarism Detection System for New York City's Local Law 144](settings/gdpr-and-nyc-ai-laws/9355824728-summary-of-bias-audit-results-of-the-devplatform%27s-plagiarism-detection-system-for-new-york-city%27s-local-law-144.md)
## Settings / Insights
...
- [Skills on DevPlatform](settings/roles-management/3872148153-skills-on-devplatform.md)
...
- [Lock User Access Prerequisite Locking user access Unlocking user access](settings/teams-management/6534774997-locking-user-access-from-devplatform.md)
...
- [DevPlatform's Approach to Accessibility](settings/user-account-settings-and-preferences/8440817776-devplatform%27s-approach-to-accessibility.md)
...
- [Safelist/Allowlist URLs and IP Addresses for DevPlatform Affected areas Allowlist URLs Allowlist IP addresses](settings/user-account-settings-and-preferences/6769658535-safelist-or-allowlist-urls-for-devplatform.md)
...
- [DevPlatform Role Certifications Guidelines](skillup/getting-started/9866041175-devplatform-role-certifications-guidelines.md)
- [DevPlatform SkillUp](skillup/getting-started/4624433684-devplatform-skillup.md)
- [DevPlatform SkillUp Licenses](skillup/getting-started/1238999371-devplatform-skillup-licenses.md)
