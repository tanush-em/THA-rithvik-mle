...
source_url: "https://support.devplatform.com/articles/9005750838-setting-up-scim-provisioning-for-skillup"
...
- You have generated a **SCIM Access Key** in your DevPlatform for Work account. For more information, see [Generating an API Key from DevPlatform](https://support.devplatform.com/articles/3939437783-setting-up-scim-provisioning-with-okta#generating-an-api-key-from-devplatform-18) section.
...
|-------------------------|-------------------------------------------|
| **Item**                | **Value**                                 |
| **Base URL**            | `https://services.devplatform.com/scim/v2` |
