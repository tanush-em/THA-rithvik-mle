...
source_url: "https://support.devplatform.com/articles/3081122402-reporting-apis"
...
```
curl -X POST https://www.devplatform.com/skillup/api/v1/oauth2/token \
...
```
curl -X GET https://www.devplatform.com/skillup/api/v2/credentials \
...
For more information, contact [skillup-support@devplatform.com](mailto:skillup-support@devplatform.com).‭
