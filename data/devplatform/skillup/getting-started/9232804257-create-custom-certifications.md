---
title: "Create Custom Certifications Prerequisite Creating custom certifications"
title_slug: "create-custom-certifications-prerequisite-creating-custom-certifications"
source_url: "https://support.devplatform.com/articles/9232804257-create-custom-certifications"
article_slug: "9232804257-create-custom-certifications"
...
# Create Custom Certifications Prerequisite Creating custom certifications

_Last updated: Apr 22, 2026, 10:22 AM (Last updated 4 days ago)_

Custom Certifications let you convert a DevPlatform for Work test into a SkillUp certification experience. This allows you to create certifications that align with your organization’s learning and skill validation requirements.

# Prerequisite

You have created a test in your DevPlatform for Work account.
...
1.  Enter a name for the certification.

2.  Enter a description that explains what the certification covers.

3.  Click **Continue**.

## Step 2: Import DevPlatform for Work test

1.  Search and select a test under the **Linked DevPlatform for Work test** field.
...
1.  Enter the minimum score required to pass the certification in the **Overall cutoff percentage** field.
