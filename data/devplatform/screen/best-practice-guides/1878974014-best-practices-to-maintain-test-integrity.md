...
source_url: "https://support.devplatform.com/articles/1878974014-best-practices-to-maintain-test-integrity"
...
You can enable the [Copy-Paste](https://support.devplatform.com/hc/en-us/articles/360011479133-Proctoring-DevPlatform-Tests#copypaste-tracking) option to monitor and track the number of times candidates copy or paste content from external sources. 
...
Activate [Tab Proctoring](https://support.devplatform.com/hc/en-us/articles/360011479133-Proctoring-DevPlatform-Tests#tab-proctoring) to monitor if a candidate leaves the test window during the assessment. This feature can track the number of times the candidate left the test screen and the total time spent away from the test screen. 
...
**Note:** If continuous image capturing is not required, you can use the [Photo Identification](https://support.devplatform.com/articles/7825915809-impersonation-detection#photo-identification-3) feature to capture a photo of the candidate before the test begins.
...
[AI Plagiarism Detection](https://support.devplatform.com/hc/en-us/articles/115005603547-Plagiarism-Detection-Using-MOSS-Measure-of-Software-Similarity) is highly recommended if your organization can utilize AI in the hiring process. 
...
- If concerns about a candidate's test integrity remain, request an explanation of their approach in a [live interview](https://support.devplatform.com/hc/en-us/articles/115007439768-Key-Interview-Features). During the interview, ask them to modify their submitted code to demonstrate their understanding.
