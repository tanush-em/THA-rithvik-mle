---
title: "Mitigating Candidate Drop-Off"
title_slug: "mitigating-candidate-drop-off"
source_url: "https://support.devplatform.com/articles/5269412517-mitigating-candidate-drop-off"
article_slug: "5269412517-mitigating-candidate-drop-off"
last_updated_exact: "Dec 24, 2024, 4:51 PM"
...
- Ensure recruiters build out a detailed and exciting candidate invite [email template](https://support.devplatform.com/hc/en-us/articles/360010817373-Creating-an-Email-Template) talking about company culture, team, interview process, and next steps.

- Ensure recruiters set clear [test instructions](https://support.devplatform.com/hc/en-us/articles/360000109287-Modifying-Candidate-Settings-for-Tests#candidate-details) about the role and skills going to be assessed, along with the next steps in the interview process.

- Ensure candidates take the sample test to familiarize themselves with the DevPlatform platform and build confidence to take the assessment. 

- Share the [Community Interview Prep Kit](https://www.devplatform.com/interview/interview-preparation-kit) page (for additional warm-up challenges) in the email invite/test instructions.

- Set up automated [Reminder emails](https://support.devplatform.com/hc/en-us/articles/360000195788-Modifying-Email-Settings-for-Tests#reminder-emails) through the platform. Another recommendation is to manually send out a re-invite through the platform for the ones who are yet to take the test even after the first reminder. This re-invite will trigger the second reminder email if the reminder setting is still on.
...
- Showcase the culture in the organization at every communication stage.
  ...
  - Provide links to the [Candidate Support Page](https://candidatesupport.devplatform.com/hc/en-us) to enable candidates to prepare for, take part in, or follow up on an assessment or interview, along with answers to FAQs.
