---
title: "Limitations With DevPlatform Projects"
title_slug: "limitations-with-devplatform-projects"
source_url: "https://support.devplatform.com/articles/3052727240-limitations-with-devplatform-projects"
article_slug: "3052727240-limitations-with-devplatform-projects"
...
# Limitations With DevPlatform Projects

_Last updated: Oct 22, 2025, 9:18 PM (Last updated 6 months ago)_

The project questions on DevPlatform use VM-based containers, with specific limitations on the number of workspaces a company can have at any given time. 
...
- Reach out to [support@devplatform.com](mailto:support@devplatform.com) if your requirement exceeds the default threshold. Given the limitations, inviting candidates in batches to stagger logins is recommended. Also, the limits remain the same irrespective of the test duration, as the table above mentions.

- For both Project questions and non-project questions, if the requirement is more than 5,000 simultaneous attempts, reach out to [support@devplatform.com](mailto:support@devplatform.com).

#### **Related Articles:**

- [Creating a DevPlatform Project Question](https://kb.devplatform.com/articles/1570281449-creating-front-end%2C-back-end-full-stack-and-mobile-questions)

- [Front-end, Back-end, and Full Stack Developer](https://kb.devplatform.com/articles/1570281449-creating-front-end%2C-back-end-full-stack-and-mobile-questions)

- [Data Science](https://kb.devplatform.com/articles/5187107609-data-science-questions)

- [Database Engineer](https://kb.devplatform.com/articles/8826242281-database-engineer-questions)

- [Code Review](https://kb.devplatform.com/articles/4262355406-code-review-questions)

- [Mobile Development](https://kb.devplatform.com/articles/1570281449-creating-front-end%2C-back-end-full-stack-and-mobile-questions)

- [Scoring Front end, Back end, and Full-stack Questions](https://kb.devplatform.com/articles/4110011178-scoring-front-end%2C-back-end-and-full-stack-questions)

- [Manual Scoring of Data Science Questions](https://kb.devplatform.com/articles/1079079701-manual-scoring-of-data-science-questions-)

- [Auto Scoring of Data Science Questions](https://kb.devplatform.com/articles/8932030959-automatic-scoring-of-data-science-questions)

- [Taking Front-end, Back-end, Full-Stack Developer assessments](https://candidatesupport.devplatform.com/hc/en-us/articles/4402921107091-Taking-Front-end-Back-end-Full-stack-developer-assessments)

- [Blog](https://www.devplatform.com/blog/devplatform-projects-supports-data-science-skills/)
