...
source_url: "https://support.devplatform.com/articles/5663779659-proctor-mode"
...
**Note:** When Proctor Mode is enabled, **AI Plagiarism Detection** and **Image Analysis** are enabled by default. You can disable Image Analysis, but DevPlatform recommends enabling it for full session integrity.
...
- External AI coding assistants, such as third-party AI tools or copilots, not integrated within DevPlatform’s IDE.
