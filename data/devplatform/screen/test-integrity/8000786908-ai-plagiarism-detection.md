...
source_url: "https://support.devplatform.com/articles/8000786908-ai-plagiarism-detection"
...
**Note:** Given that it’s a Machine Learning model, we comply with the audit requirements mentioned in the [](https://support.devplatform.com/articles/8514725302-summary-of-bias-audit-results-(devplatform's-image-analysis-system)) [AEDT / NYC AI law](https://support.devplatform.com/articles/8514725302-summary-of-bias-audit-results-(devplatform's-image-analysis-system))[.](https://support.devplatform.com/articles/8514725302-summary-of-bias-audit-results-(devplatform's-image-analysis-system))  
...
DevPlatform’s dedicated ML team continuously improves the plagiarism detection model by learning from emerging patterns of code plagiarism and misclassifications. When a statistically significant improvement is made, new updates to the model are deployed automatically.

## FAQs

**Will coding in an external IDE instead of the DevPlatform platform trigger a potential cheating flag?**

If candidates use Projects, which support an offline workflow (coding in their own IDE and pushing the code to the DevPlatform platform), no cheating flag is triggered.

However, if candidates solve a standard coding question in an external IDE and copy and paste their code into the DevPlatform platform, the system is likely to flag this behavior as suspicious activity.

## Related Articles

- Standard Plagiarism Detection - [](https://support.devplatform.com/hc/en-us/articles/115005603547-Plagiarism-Detection-Using-MOSS-Measure-of-Software-Similarity) [Moss model](https://support.devplatform.com/articles/2106056073-plagiarism-detection-using-moss-(measure-of-software-similarity))

- Future of Hiring with AI - [](https://support.devplatform.com/hc/en-us/articles/31668981495187-The-Next-Generation-of-Hiring-Interview-Features) [Next-gen Hiring Process](https://support.devplatform.com/articles/5377881818-the-next-generation-of-hiring%3A-interview-features)

- [Plagiarism Best Practices](https://support.devplatform.com/articles/4291690360-plagiarism-best-practices-guide)[](https://support.devplatform.com/articles/4291690360-plagiarism-best-practices-guide)
