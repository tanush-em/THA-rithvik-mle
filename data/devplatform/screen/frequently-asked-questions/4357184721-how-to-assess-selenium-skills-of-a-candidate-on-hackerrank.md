---
title: "How to Assess Selenium Skills of a Candidate on DevPlatform?"
title_slug: "how-to-assess-selenium-skills-of-a-candidate-on-devplatform"
source_url: "https://support.devplatform.com/articles/4357184721-how-to-assess-selenium-skills-of-a-candidate-on-devplatform"
article_slug: "4357184721-how-to-assess-selenium-skills-of-a-candidate-on-devplatform"
...
# How to Assess Selenium Skills of a Candidate on DevPlatform?

_Last updated: Dec 13, 2024, 5:47 AM (Last updated 1 year ago)_

## Overview

DevPlatform now enables Selenium skills that can be leveraged to assess QA Engineers and Back-End Developers. Please see here before we proceed to learn how to create and score questions on the DevPlatform library. 
...
## Selenium Projects tasks in the DevPlatform Library

DevPlatform's Projects questions associated with Selenium skills cover a wide array of topics. Ranging from basic operations to advanced skills, Selenium developers are assessed on competencies such as: 
...
- **Web Scraping** - Questions to set up web-scraping to extract valuable data and information web browser automation, among others. 
...
- Other common competencies tested using DevPlatform Selenium questions include Fundamental Java programming knowledge, knowledge of XPath, CSS, HTML, and DOM.

\

**Note**: Validated by our [DevPlatform's Skills Advisory Council](https://www.devplatform.com/skills-directory/skills-advisory-council), we also provide the [DevPlatform Skills Directory](https://www.devplatform.com/skills-directory), which clearly defines the Selenium competencies that can be leveraged while assessing candidates. Please see the key competencies in the Selenium Skills Directory [here](https://www.devplatform.com/skills-directory/selenium_basic).
