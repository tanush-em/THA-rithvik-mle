...
source_url: "https://support.devplatform.com/articles/9625818007-code-quality-evaluation"
...
DevPlatform provides a prompt listing specific rules and issues to the AI model along with the candidate’s code. The AI generates feedback on the code and organizes comments into different categories. Based on this feedback, the system uses a straightforward method to evaluate code quality.

DevPlatform uses the time-debt method to create a grading system for code quality. This evaluates how long it takes to fix a mistake compared to how long it took to write the code. If fixing the mistake takes much longer, the code quality is considered poor. This helps quantify the impact of low-quality code and enables consistent grading across different solutions and programming languages.
...
Turn on **Advanced Evaluation** to enable code quality evaluation for all tests. For more information, see [Enable Advanced Evaluation](https://support.devplatform.com/articles/7098008997-advanced-evaluation#enable-advanced-evaluation-6).
