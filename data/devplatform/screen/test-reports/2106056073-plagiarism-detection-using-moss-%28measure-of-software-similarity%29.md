...
source_url: "https://support.devplatform.com/articles/2106056073-plagiarism-detection-using-moss-%28measure-of-software-similarity%29"
...
DevPlatform employs two primary models to detect plagiarism, specifically in coding questions:
...
2.  [AI Plagiarism Detection:](https://devplatform-knowledge-base.help.usepylon.com/articles/8000786908-ai-plagiarism-detection) [](https://devplatform-knowledge-base.help.usepylon.com/articles/8000786908-ai-plagiarism-detection) To detect sophisticated and AI-aided plagiarism attempts, DevPlatform leverages an advanced AI-based model. This feature is an option that can be enabled if required. 
...
MOSS plagiarism detection is turned on by default for all DevPlatform tests. 
...
- For more details, see the [Plagiarism Best Practices Guide](https://devplatform-knowledge-base.help.usepylon.com/articles/4291690360-plagiarism-best-practices-guide)[.](https://devplatform-knowledge-base.help.usepylon.com/articles/4291690360-plagiarism-best-practices-guide)

- [Tab Proctoring](https://devplatform-knowledge-base.help.usepylon.com/articles/1079706165-proctoring-devplatform-tests#tab-proctoring-18) and [Copy-paste tracking](https://devplatform-knowledge-base.help.usepylon.com/articles/1079706165-proctoring-devplatform-tests#copy-paste-tracking-8) can also be used for questions without plagiarism detection capabilities.

- For further guidance, refer to the [Downloading PDF and Test Reports](https://devplatform-knowledge-base.help.usepylon.com/articles/1786677446-downloading-pdf-and-excel-test-reports) article.
