...
source_url: "https://support.devplatform.com/articles/2564162886-modifying-email-settings-for-tests"
...
You can manage the emails sent before, during, and after a test. DevPlatform lets you configure the following types of test emails:
...
4.  Go to **Settings \> Emails.**
    ...
    - [Configure Test Reports Email](https://support.devplatform.com/articles/2564162886-modifying-email-settings-for-tests#configure-test-reports-emails-7)

    - [Configure Leakage Alert Emails](https://support.devplatform.com/articles/2564162886-modifying-email-settings-for-tests#configure-leakage-alert-emails-14)

    - [Configure Reminder Emails](https://support.devplatform.com/articles/2564162886-modifying-email-settings-for-tests#configure-reminder-emails-20)

    - [Configure Invite Email](https://support.devplatform.com/articles/2564162886-modifying-email-settings-for-tests#configure-invite-email-24)

    - [Configure Confirmation Email](https://support.devplatform.com/articles/2564162886-modifying-email-settings-for-tests#configure-confirmation-emails-29)
...
You can add users to receive notifications when DevPlatform detects a leaked test question.
...
- DevPlatform automatically sends an email notification to these users when a potential content leak is detected.
