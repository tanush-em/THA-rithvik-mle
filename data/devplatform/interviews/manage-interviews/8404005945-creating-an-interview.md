---
title: "Create an Interview Starting an interview immediately Scheduling an interview Search and filter Interviews Join as an Interviewer Candidate experience"
title_slug: "create-an-interview-starting-an-interview-immediately-scheduling-an-interview-search-and-filter-interviews-join-as-an-interviewer-candidate-experience"
source_url: "https://support.devplatform.com/articles/8404005945-creating-an-interview"
article_slug: "8404005945-creating-an-interview"
last_updated_exact: "Apr 22, 2026, 2:58 PM"
...
# Create an Interview Starting an interview immediately Scheduling an interview Search and filter Interviews Join as an Interviewer Candidate experience

_Last updated: Apr 22, 2026, 2:58 PM (Last updated 4 days ago)_
...
4.  In the **Interview Details** panel:
    ...
    - (Optional) Click **View More** to expand additional fields. 
      ...
      - Provide the candidate’s **Name and Phone Number.**
    ...
    - (Optional) Select an **Interview Template**.
      ...
      **Note:** 
      ...
      - If you do not select a template, select an **Interview Scorecard**. If you do not select a scorecard, DevPlatform uses the default scorecard.
...
5.  Click **Invite Participants** to schedule an Interview.
    ...
    - (Optional) Add email notes. Only the interviewer can view these notes.

6.  Click **Save and Send Email** to send the invitations. 

DevPlatform sends email notifications to candidates and interviewers. The notifications include the date, time, and a link to join the interview.
...
2.  Use the search bar or filters to find specific interviews.
...
- If you are not logged in to DevPlatform for Work, the login page appears. Log in with your DevPlatform for Work credentials.
