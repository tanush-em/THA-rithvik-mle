---
title: "Add Questions to Interview Prerequisite Adding questions to an interview"
title_slug: "add-questions-to-interview-prerequisite-adding-questions-to-an-interview"
source_url: "https://support.devplatform.com/articles/6761309830-adding-questions-to-interviews"
article_slug: "6761309830-adding-questions-to-interviews"
last_updated_exact: "Apr 22, 2026, 11:38 AM"
...
# Add Questions to Interview Prerequisite Adding questions to an interview

_Last updated: Apr 22, 2026, 11:38 AM (Last updated 4 days ago)_

You can add existing questions from the DevPlatform Library, your company library, or by creating custom questions during an interview session.
...
- [Question Tiles](https://support.devplatform.com/articles/6761309830-adding-questions-to-interviews#using-question-tiles-6)

- [Question Library](https://support.devplatform.com/articles/6761309830-adding-questions-to-interviews#using-question-library-11)

- [Templates](https://support.devplatform.com/articles/6761309830-adding-questions-to-interviews#using-templates-14)

- [Code Repositories](https://support.devplatform.com/articles/6761309830-adding-questions-to-interviews#using-code-repositories)

- [Screen Tests](https://support.devplatform.com/articles/6761309830-adding-questions-to-interviews#import-questions-from-screen-test-27)
...
2.  Follow the instructions for the selected question type.
    ...
    - **Coding or Whiteboard Question:** Create a custom question or import a question from the library.
      ...
      - Create a custom question:
        ...
        3.  Click **Save.** The system automatically generates the question title.

        4.  (Optional) Click the pencil icon next to the question title to change the title.

      - Select **Library** to browse and import questions from the Library. To access your custom-created questions, select **My Questions** from the **Show** dropdown. For more information, see [Using Question Library](https://support.devplatform.com/articles/6761309830-adding-questions-to-interviews#using-question-library-11).

    - **Code Repository Question:** Assess candidates using real-world tasks.

      1.  Select the **Code Repositories** tile.

      2.  Select a repository to view its details and tasks.
    ...
    - **Project Question:** Choose one of the following options:
      ...
      - **Import from Library:** Open the DevPlatform Library filtered by the selected question type. For more information, see Using Question Library.
...
2.  Use the search bar or filters to quickly find the questions.
    ...
    - **Filter:** You can filter questions by the following attributes:
      ...
      - **Show:**
        ...
        - **DevPlatform Library:** Displays questions from the DevPlatform Library. 
