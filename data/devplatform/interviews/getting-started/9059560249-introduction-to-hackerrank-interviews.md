---
title: "Introduction to DevPlatform Interviews"
title_slug: "introduction-to-devplatform-interviews"
source_url: "https://support.devplatform.com/articles/9059560249-introduction-to-devplatform-interviews"
article_slug: "9059560249-introduction-to-devplatform-interviews"
last_updated_exact: "Apr 22, 2026, 1:41 PM"
...
# Introduction to DevPlatform Interviews

_Last updated: Apr 22, 2026, 1:41 PM (Last updated 4 days ago)_

DevPlatform Interviews is an online platform for conducting live coding interviews. Interviewers can use the platform to invite candidates to a live session, where both the candidate and the interviewer communicate, write code, and collaborate in real time.

Use the following sample links to explore the DevPlatform Interviews platform:

- [Interviewer experience](https://hr.gs/newint)

- Candidate experience

  - [Front-end engineer interview](https://hr.gs/sampleint-fe)

  - [Back-end engineer interview](https://hr.gs/sampleint-be)

  - [Datascience engineer interview](https://hr.gs/sampleint-ds)

  - [Code repository interview](https://hr.gs/sampleint-v2)
...
**Note:** Open the interview link in an incognito window or a browser where you are not logged in to a DevPlatform account.

This article outlines the key features of the DevPlatform Interview platform, which is designed to streamline the interview process and help you efficiently identify top candidates.

## Key capabilities

The DevPlatform Interview platform offers the following core capabilities:
...
- **Schedule an interview:** Set a specific date and time for the interview. DevPlatform sends email notifications to the candidate and the interviewer. The email includes the scheduled date and time and a link to join the interview. Interviewers may also receive additional information, such as the candidate’s phone number, resume, and any notes you provide.

- **Start an interview immediately:** You can start an interview immediately. DevPlatform does not send notifications. You must manually share the link with candidates and communicate the time and details to all participants.
...
For more information, see [Standardizing Interviews Using Templates](https://support.devplatform.com/articles/2837093779-standardizing-interviews-using-templates).

### Import questions

DevPlatform Interviews supports various question types such as Coding, Front-End, Back-End, Full-Stack, Database, and more. You can add questions to the interview from the **Explore** tab in the left pane.

![image.png](https://assets.usepylon.com/e6a58e21-be80-4777-9eaf-f73beeee94d9%2F1753787277545-image.png?Expires=253370764800&Signature=A7Lapkm1pdW2sA0vRqgDPgfkrxLsOm71cLKYbzHDY3HzVYQRHF45MnBGy6XPWkPO8U8VwurqSOq0MdvzY8TL6vpyKM0ZVKrkgCzT-gvs01poevo7xvAjVRTTBNHV6HYvByWMrzmv-ku5g7jfHVr0d4PyuqyFnCn4T8xjvzQpxna9R4yBrZ3RurIsfBJRn~9mv4kBXK~E9XzSDTcOf~Pa1TdSb3FBZGB841mrazbXWNteUb0ZBq0TtGgjDuCnlHh5b~cPJTLHZPrLoU-ipXkpf~lIw-daIMfzgipC3yOwI5Ki0pgf7rJDoWK1ntIDVGYt~cxBNsYlWgSYUUps4l20cg__&Key-Pair-Id=K3NV4LZ47N8M46)

Alternatively, you can use the **Questions** tab to import questions directly from the Question Library.

![image.png](https://assets.usepylon.com/e6a58e21-be80-4777-9eaf-f73beeee94d9%2F1753787331421-image.png?Expires=253370764800&Signature=nJev80MsGIfulHUFQ9jCjXr2jKtnzbzD-9jFJ6BoFI5oo7UqfX4BCR31FrarlNGNg2~qP6fYrtMkXDgSgN-ftvT0x6PFvAogMIHStzgCjKN94TBN4kslZlRG9S-XwqH4gqJyjA0aRvJ-EyJLorXO7G4ucd7zZPLzfcnE9ZejqwSpbAHP4r1Swp2GB4HAz0DDOWnEycTDhDm7Sihp4tZEYfnBQOyXOxnGkK5HicMte4VBUJ4K5TdwJtwyvTG2UijFK-QmyqKPhd4vyHubzPxmDYB-nEYCrvN6mAH7s82CdOUihnkaHsoa-yYQiLXPuOKt4RHrRP~ot6he2ge7Ldj9IA__&Key-Pair-Id=K3NV4LZ47N8M46)

For more information, see [Adding Questions to Interviews](https://support.devplatform.com/articles/6761309830-adding-questions-to-interviews).
...
For more information, see [Importing Project Questions in DevPlatform Interview.](https://support.devplatform.com/articles/1769104522-importing-projects-in-devplatform-interview-)
...
- **Console:** Supports real-time execution in supported REPL languages such as Python, JavaScript, and Ruby. For more information, see [REPL Support in DevPlatform.](https://support.devplatform.com/articles/6400859375-repl-support-in-interviews)

### Live communication

DevPlatform Interview supports real-time communication between the candidate and interviewer through text, audio, and video chat.
...
Interview Integrity Signals notify interviewers only when the system detects meaningful clusters of suspicious candidate activity. For more information, see [Interview Integrity Signals.](https://support.devplatform.com/articles/5161582600-interview-integrity-signals)

### Interviewer Scorecard

The Interviewer Scorecard is a private scorecard that allows the interviewer to rate candidates on the specific skills related to the role. The platform auto-saves all ratings and feedback. For more information, see [Interview Scorecards](https://support.devplatform.com/articles/9842091173-interview-scorecards).

If you use a scorecard template, you can also add custom skills. For more information, see [Adding Skills to an Interview Scorecard](https://support.devplatform.com/hc/en-us/articles/1500008525861-Standardizing-Interviews-Using-Templates#adding-skills-to-a-template).

### Reports

When an interview ends, DevPlatform automatically generates a detailed report to support evaluation and hiring decisions. You can download the report as a PDF, share it with your team, and update the hiring status.

For more information, see [Viewing Interview Reports](https://support.devplatform.com/articles/6788713830-viewing-interview-reports).
