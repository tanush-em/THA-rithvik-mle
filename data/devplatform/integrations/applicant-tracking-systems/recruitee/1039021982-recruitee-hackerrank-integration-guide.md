---
title: "Recruitee - DevPlatform Integration Guide Prerequisites Integrating Recruitee with DevPlatform"
title_slug: "recruitee-devplatform-integration-guide-prerequisites-integrating-recruitee-with-devplatform"
source_url: "https://support.devplatform.com/articles/1039021982-recruitee-devplatform-integration-guide"
article_slug: "1039021982-recruitee-devplatform-integration-guide"
...
# Recruitee - DevPlatform Integration Guide Prerequisites Integrating Recruitee with DevPlatform

_Last updated: Jan 30, 2026, 12:26 PM (Last updated 3 months ago)_

DevPlatform integrates with Recruitee to let you invite candidates to DevPlatform assessments and interviews directly from Recruitee.

# Prerequisites

Before you begin, ensure you meet the following requirements:

- You have admin access to your DevPlatform and Recruitee accounts.

- Your organization has an active Enterprise plan with DevPlatform.

# Integrating Recruitee with DevPlatform

To integrate Recruitee with DevPlatform:

## Step 1: Generate an integration API token in DevPlatform

The integration API token allows Recruitee to connect securely with your DevPlatform account.

1.  Log in to your DevPlatform account using your credentials.

2.  Go to **Settings \> Integrations \> Recruitee \> Connect**, or open the [Recruitee integration](https://www.devplatform.com/work/settings/integrations/recruitee/configuration) page directly.
...
4.  Click **Copy and close** to copy your token.
    ...
    **Note:** You need this token in Step 2: Add the DevPlatform API token in Recruitee.

## Step 2: Add the DevPlatform API token in Recruitee

This step authorizes Recruitee to connect with your DevPlatform account. 
...
Your Recruitee account is now integrated with DevPlatform.
