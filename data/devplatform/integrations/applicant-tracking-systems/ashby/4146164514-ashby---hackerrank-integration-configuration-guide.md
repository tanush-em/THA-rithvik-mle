---
title: "Ashby - DevPlatform Integration Configuration Guide"
title_slug: "ashby-devplatform-integration-configuration-guide"
source_url: "https://support.devplatform.com/articles/4146164514-ashby---devplatform-integration-configuration-guide"
article_slug: "4146164514-ashby---devplatform-integration-configuration-guide"
...
# Ashby - DevPlatform Integration Configuration Guide

_Last updated: Mar 11, 2026, 3:54 PM (Last updated 2 months ago)_

## Overview

DevPlatform's Tests integrate with Ashby to facilitate a seamless and efficient candidate screening process for recruiters. As part of their interview workflow, Ashby users can directly send DevPlatform Test invites to candidates and obtain the Test report for further evaluation.

This article provides you with detailed configuration steps on DevPlatform and Ashby.

- [Prerequisites](https://support.devplatform.com/articles/4146164514-ashby---devplatform-integration-configuration-guide#prerequisites-4)

- [Configuring Ashby Integration with DevPlatform](https://support.devplatform.com/articles/4146164514-ashby---devplatform-integration-configuration-guide#configuring-ashby-integration-with-devplatform-6)

  - [Generating an API Key from DevPlatform](https://support.devplatform.com/articles/4146164514-ashby---devplatform-integration-configuration-guide#generating-an-api-key-from-devplatform-8)

  - [Adding the API Key in Ashby](https://support.devplatform.com/articles/4146164514-ashby---devplatform-integration-configuration-guide#adding-the-api-key-in-ashby-11)
...
<tbody>
<tr>
<td data-colspan="1" data-rowspan="1" style="background-color: #eafcef; width: 436px"><p><strong>In DevPlatform for Work</strong></p></td>
...
<li><p>Log in using the Ashby account, which has the same email address as the <strong>DevPlatform for Work Company Admin</strong> user account. This is important for sending DevPlatform Test invites from Ashby.</p></li>
</ul>
<p><em>Example: If the email address in DevPlatform for Work is </em>[jackpeters@devplatform.com,](mailto:jackpeters@devplatform.com,) <em>the Ashby user account must also include the same email address.</em></p>
<ul>
...
## Configuring Ashby Integration with DevPlatform

When configuring the Ashby integration with DevPlatform for the first time, the administrator generates an API key. The administrator must keep a record of this API key for further use.
...
2.  Search and click the **DevPlatform** tile.

3.  The DevPlatform pane opens on the right. Click **Enable DevPlatform**.
...
6.  Now add the DevPlatform API key that you generated from the [DevPlatform for Work platform](https://support.devplatform.com/articles/4146164514-ashby---devplatform-integration-configuration-guide#configuring-ashby-integration-with-devplatform-6)[.](https://support.devplatform.com/articles/4146164514-ashby---devplatform-integration-configuration-guide#configuring-ashby-integration-with-devplatform-6)
...
7.  Select the integration partner as **DevPlatform** from the drop-down.
...
9.  To check the integration, go to **Ashby API \> API Keys**. The integration with DevPlatform is displayed as **Active**.
...
**Note:** The email ID that you have used with your Ashby account should be the same as the email ID associated with your DevPlatform account for the integration to work seamlessly.
