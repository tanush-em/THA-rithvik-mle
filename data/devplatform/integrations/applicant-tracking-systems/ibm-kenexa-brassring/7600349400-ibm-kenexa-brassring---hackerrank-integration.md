---
title: "IBM Kenexa BrassRing - DevPlatform Integration"
title_slug: "ibm-kenexa-brassring-devplatform-integration"
source_url: "https://support.devplatform.com/articles/7600349400-ibm-kenexa-brassring---devplatform-integration"
article_slug: "7600349400-ibm-kenexa-brassring---devplatform-integration"
...
- Support for Candidates on Multiple Requisitions.
  ...
  - If a Candidate applies to multiple requisitions, they only need to take the DevPlatform assessment once, the results will be sent to all requisitions that requested the test.

  - If a candidate has taken the test in the past, the historical result will be sent back to BrassRing.

- Preserve DevPlatform role-based access and permissions when taking actions in BrassRing
...
Please refer to the following articles to set up and use the BrassRing- DevPlatform Integration:\
\

- [📄 IBM Kenexa BrassRing - DevPlatform Tests Integration](/articles/7795424803)
  \
