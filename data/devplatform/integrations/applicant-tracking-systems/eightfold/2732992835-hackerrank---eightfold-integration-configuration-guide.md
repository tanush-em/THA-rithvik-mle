---
title: "DevPlatform - Eightfold Integration Configuration Guide"
title_slug: "devplatform-eightfold-integration-configuration-guide"
source_url: "https://support.devplatform.com/articles/2732992835-devplatform---eightfold-integration-configuration-guide"
article_slug: "2732992835-devplatform---eightfold-integration-configuration-guide"
...
3.  Search for **DevPlatform - Assessments & Interviews**, and open the app installation page.

4.  Click **Install**.

5.  In the **Configure Settings to Install App** window, enter the **API Key** generated from the DevPlatform platform.

6.  Enter the appropriate **Stage** for the app (e.g., **Recruiter Screen**).

7.  Set the **Webhook Authentication Type** to **no_auth** to receive notifications on DevPlatform assessments and interviews.
...
9.  To verify, go to **Apps** \> **Installed Apps** to see the **DevPlatform - Assessments & Interviews** app listed.
