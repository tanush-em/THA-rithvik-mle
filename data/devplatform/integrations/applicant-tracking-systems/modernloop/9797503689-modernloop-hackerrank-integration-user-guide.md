---
title: "ModernLoop - DevPlatform Integration User Guide Prerequisites Integrating ModernLoop with DevPlatform Using DevPlatform integration"
title_slug: "modernloop-devplatform-integration-user-guide-prerequisites-integrating-modernloop-with-devplatform-using-devplatform-integration"
source_url: "https://support.devplatform.com/articles/9797503689-modernloop-devplatform-integration-user-guide"
article_slug: "9797503689-modernloop-devplatform-integration-user-guide"
last_updated_exact: "Sep 10, 2025, 4:42 PM"
...
# ModernLoop - DevPlatform Integration User Guide Prerequisites Integrating ModernLoop with DevPlatform Using DevPlatform integration

_Last updated: Sep 10, 2025, 4:42 PM (Last updated 8 months ago)_

DevPlatform integrates with ModernLoop to create DevPlatform interview sessions for candidates. You can add the DevPlatform API key (Token key) to ModernLoop to generate DevPlatform links.

# Prerequisites

- You must have admin access to DevPlatform

- You must have admin access to ModernLoop

# Integrating ModernLoop with DevPlatform

To integrate ModernLoop with DevPlatform:

## Step 1: Generate an API key in DevPlatform
...
**Note:** The integration will stop working if the DevPlatform account that generated the API key is deprecated. Best practice is to use a dedicated admin account or create a new DevPlatform admin account specifically for this integration.

## Step 2: Connect DevPlatform to ModernLoop

1.  Log in to [ModernLoop](http://app.modernloop.io).
...
3.  Locate **DevPlatform** under the **Coding tools** section.
...
5.  Paste the API Key (Token key) you generated in DevPlatform.
...
# Using DevPlatform integration

To use DevPlatform Integration:

## Step 1: Generate DevPlatform links during scheduling

When you schedule an interview in ModernLoop:

1.  Go to the **Communications** tab in ModernLoop.

2.  Select **DevPlatform** to open the modal.

3.  Click **+ Add DevPlatform link** to auto-generate a link for the interview.

## Step 2: Add DevPlatform links to interview plans

To automate link generation for specific job stages in ModernLoop:

1.  Go to the **Jobs** tab in ModernLoop.

2.  Select the job you want to automate for link generation.

3.  Choose the relevant job stage.

4.  Select the interview for which you want a default coding assessment link.

5.  Click the **\</\>** icon to configure the link.

Once configured, DevPlatform links will be automatically generated whenever an interview schedule is created for that stage.

**Note:** If you deprecate your DevPlatform integration, previously created links remain active. ModernLoop does not delete coding links.
