---
title: "iCIMS - DevPlatform Prime Assessments Configuration Guide"
title_slug: "icims-devplatform-prime-assessments-configuration-guide"
source_url: "https://support.devplatform.com/articles/2481948575-icims---devplatform-prime-assessments-configuration-guide"
article_slug: "2481948575-icims---devplatform-prime-assessments-configuration-guide"
...
# iCIMS - DevPlatform Prime Assessments Configuration Guide

_Last updated: Dec 27, 2024, 5:57 AM (Last updated 1 year ago)_

## Overview

DevPlatform's Tests integrate with iCIMS Prime Assessments to facilitate an efficient candidate screening process for Recruiters. As part of their interview workflow, iCIMS Prime Assessments users can send DevPlatform Test invites to candidates and obtain the Test report for further evaluation.

This article provides detailed configuration steps on DevPlatform and iCIMS Prime Assessments.
...
<li><p>Log in using the iCIMS Prime Assessments account. The Recruiter email address on the iCIMS job should match the DevPlatform email address.</p></li>
</ul>
<p><em>Example: If the email address in DevPlatform for Work is </em>[jackpeters@devplatform.com,](mailto:jackpeters@devplatform.com,) <em>the iCIMS Prime Assessments user account must also include the same email address.</em></p>
<ul>
...
## Configuring iCIMS Prime Assessments Integration With DevPlatform
...
6.  Specify a validity period for the assessments in **Set Validity Period**. This is a period in which a test taken by a candidate is valid. If a Recruiter sends an invite to take the same test within the validity period, then DevPlatform does not send an invite. In place, DevPlatform will send back the last Test results.
...
7.  Click **Save**. The iCIMS integration with DevPlatform has been established.

Related Articles:

[📄 iCIMS - DevPlatform Integration Guide](/articles/9631673147)
