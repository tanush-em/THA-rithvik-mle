---
title: "Lever V2 - DevPlatform Integration Guide Prerequisites Integrating Lever V2 for DevPlatform tests Integrating Lever V2 for DevPlatform interviews"
title_slug: "lever-v2-devplatform-integration-guide-prerequisites-integrating-lever-v2-for-devplatform-tests-integrating-lever-v2-for-devplatform-interviews"
source_url: "https://support.devplatform.com/articles/5647291926-lever-v2-devplatform-integration-guide"
article_slug: "5647291926-lever-v2-devplatform-integration-guide"
...
# Lever V2 - DevPlatform Integration Guide Prerequisites Integrating Lever V2 for DevPlatform tests Integrating Lever V2 for DevPlatform interviews

_Last updated: Mar 12, 2026, 3:22 PM (Last updated 1 month ago)_

DevPlatform integrates with Lever V2 to allow you to manage tests and interviews directly within your existing recruitment workflow.

With this integration, you can:

- Create and schedule DevPlatform Tests and Interviews directly in Lever.

- Sync statuses, feedback, and scorecards automatically between Lever and DevPlatform.

- Cancel or update tests and interviews in Lever and see those changes instantly reflected in DevPlatform.

**Note:** This version replaces the [📄 Lever DevPlatform Integration](/articles/1538275190)and removes the need for manual webhook configurations or redirect-based setup.
...
- Your DevPlatform login email address matches the email address associated with your Lever account.

- Your organization has an active Enterprise plan with DevPlatform.

# Integrating Lever V2 for DevPlatform tests

To integrate Lever V2 with DevPlatform for tests:

## Step 1: Generate an API token in DevPlatform

The integration API token allows Lever to connect securely with your DevPlatform account.
...
6.  Click **Copy and close** to copy your token.
    ...
    **Note:** You need this token in Step 2: Add the DevPlatform API token in Lever.

## Step 2: Add the DevPlatform API token in Lever

This step authorizes Lever to connect with your DevPlatform account.
...
4.  Turn on the **DevPlatform Test** toggle under the **Assessments** section.
...
5.  Paste the DevPlatform API token into the **Access token** field.

6.  Click **Verify Connection**. Lever displays the status as **Verified** after the connection succeeds.

Your Lever account is now integrated with DevPlatform to schedule tests.

# Integrating Lever V2 for DevPlatform interviews

To integrate Lever V2 with DevPlatform for interviews:

## Step 1: Generate an API key in Lever

The API key allows DevPlatform to connect securely with your Lever account.
...
5.  Select the required permission listed below under **Permissions**.
    ...
    - **Write endpoints:**
      ...
      - **add a webhook:** Create a webhook to enable real-time updates between Lever and DevPlatform.
...
8.  Click **Copy Key** and store it securely. 
    ...
    **Note:** You need this token in Step 2: Add the Lever API Key in DevPlatform.

## Step 2: Add the Lever API key in DevPlatform

This step authorizes DevPlatform to connect with your Lever account.
...
Your Lever account is now integrated with DevPlatform to schedule DevPlatform interviews.

**Note:** After you integrate DevPlatform with Zapier, refer to the following user guides to create DevPlatform assessments and interviews:

- [📄 Lever V2 - DevPlatform Integration Test User Guide](/articles/6548604920)
  \
- [📄 Lever V2 - DevPlatform Integration Interview User Guide](/articles/5269579148)
  \
