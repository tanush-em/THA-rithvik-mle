---
title: "Zapier - DevPlatform Integration Test User Guide Prerequisites Configuring Zaps for DevPlatform assessments Sending assessment invites Viewing assessment results"
title_slug: "zapier-devplatform-integration-test-user-guide-prerequisites-configuring-zaps-for-devplatform-assessments-sending-assessment-invites-viewing-assessment-results"
source_url: "https://support.devplatform.com/articles/7100809601-zapier-devplatform-integration-test-user-guide"
article_slug: "7100809601-zapier-devplatform-integration-test-user-guide"
...
# Zapier - DevPlatform Integration Test User Guide Prerequisites Configuring Zaps for DevPlatform assessments Sending assessment invites Viewing assessment results

_Last updated: Mar 28, 2026, 3:35 PM (Last updated 1 month ago)_

You can use Zapier to automate DevPlatform assessment workflows. This guide explains how to configure Zapier Tables and Zaps to:

- Send DevPlatform assessment invites to candidates.
...
# Configuring Zaps for DevPlatform assessments 

A Zap is an automated workflow that connects two or more applications to perform tasks without manual intervention.

You must configure Zaps to automate the following DevPlatform assessment workflows:
...
Create a table that Zapier uses to send DevPlatform assessment invites.
...
5.  Click **Add fields** and add the required and optional fields listed in the following table. Select the appropriate field type for each field.
    ...
    <td data-colspan="1" data-rowspan="1"><p>Unique identifier of the DevPlatform assessment.</p></td>
    ...
    <td data-colspan="1" data-rowspan="1"><p>Determines whether DevPlatform sends the assessment invite email to the candidate. Select this checkbox to send the invite.</p></td>
    ...
    <td data-colspan="1" data-rowspan="1"><p>Webhook URL that DevPlatform uses to send assessment results to Zapier. Paste the webhook URL generated in <strong>Step 1</strong>.</p></td>
    <td data-colspan="1" data-rowspan="1"><p>Required</p>
    <p><br />
    </p></td>
    </tr>
    ...
    <td data-colspan="1" data-rowspan="1"><p>Allows DevPlatform to send updates if the assessment result changes after initial submission.</p></td>
    <td data-colspan="1" data-rowspan="1"><p>Optional</p>
    <p><br />
    </p></td>
    </tr>
...
This Zap connects the **Assessment invites** table to DevPlatform.
...
12. In the **Test** section, click **Test step** to send a DevPlatform assessment invite using the sample data you added in the **Assessment invite** table in Step 2. Verify that the candidate email address receives the email.

13. Click **Publish**.

**Step 4: Create a table to store assessment results**

Create a table to store candidate assessment results sent from DevPlatform.
...
5.  Click **Add fields** and add the fields you want to store from the DevPlatform assessment report (for example, candidate name, score, or test status). Refer to the DevPlatform [sample assessment report](https://drive.google.com/file/d/1jIZzpQhe_NnzJcy7YoW7Jg1BTz18p_q_/view?usp=sharing) to identify the available result fields. Select the appropriate field type for each field (for example, Text, Number, or Checkbox).

**Note:** Zapier Table is one option to store assessment results from DevPlatform. You can also store results in apps such as Google Sheets or Slack, depending on your workflow needs.

**Step 5: Complete a sample DevPlatform assessment**
...
After you submit the assessment, DevPlatform sends the assessment results to Zapier for testing.

**Step 6: Complete Zap configuration to receive assessment results**

Complete the Zap created in **Step 1** to store assessment results from DevPlatform.
...
7.  In the **Test** section, click **Test step** to verify that DevPlatform sends the assessment results to the **Assessment results** table created in Step 4.

8.  Click **Publish**.

Your DevPlatform assessment Zap automation is now complete.

# Sending assessment invites

After you have configured the Zaps for DevPlatform assessment, you can send assessment invites to candidates.
...
Zapier sends DevPlatform assessment invites to candidates based on the on the data you enter.
