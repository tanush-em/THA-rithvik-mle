---
title: "Zapier - DevPlatform Integration Interview User Guide Prerequisites Configuring Zaps for DevPlatform interviews Sending interview invites Viewing interview results"
title_slug: "zapier-devplatform-integration-interview-user-guide-prerequisites-configuring-zaps-for-devplatform-interviews-sending-interview-invites-viewing-interview-results"
source_url: "https://support.devplatform.com/articles/5179178131-zapier-devplatform-integration-interview-user-guide"
article_slug: "5179178131-zapier-devplatform-integration-interview-user-guide"
...
# Zapier - DevPlatform Integration Interview User Guide Prerequisites Configuring Zaps for DevPlatform interviews Sending interview invites Viewing interview results

_Last updated: Mar 6, 2026, 12:30 AM (Last updated 2 months ago)_

You can use Zapier to automate DevPlatform interview workflows. This guide explains how to configure Zapier Tables and Zaps to:

- Send DevPlatform interview invites to candidates.
...
- You have active DevPlatform and Zapier accounts.

- The DevPlatform integration with Zapier is complete. For more information, see [📄 Zapier - DevPlatform Integration Guide](/articles/9883166979).

# Configuring Zaps for DevPlatform interviews 

A Zap is an automated workflow that connects two or more applications to perform tasks without manual intervention.

You must configure Zaps to automate the following DevPlatform interview workflows:
...
This step is used only to generate a webhook URL that DevPlatform uses to send assessment results.
...
Create a table that Zapier uses to send DevPlatform interview invites.
...
5.  Click **Add fields** and add the required and optional fields listed in the following table. Select the appropriate field type for each field.
    ...
    <td data-colspan="1" data-rowspan="1" data-colwidth="171" style="width: 171px"><p>Determines whether DevPlatform sends the interview invite email to the candidate. Select this checkbox to send the invite.</p></td>
    ...
    <td data-colspan="1" data-rowspan="1" data-colwidth="171" style="width: 171px"><p>Webhook URL that DevPlatform uses to send interview results to Zapier. Paste the webhook URL generated in <strong>Step 1</strong>.</p></td>
...
This Zap connects the **interview invite** table to DevPlatform.
...
12. In the **Test** section, click **Test step** to send a DevPlatform interview invite using the sample data you added in the **Interview invite** table in Step 2. Verify that the candidate email address receives the email.

13. Click **Publish**.

**Step 4: Create a table to store interview results**

Create a table to store candidate interview results sent from DevPlatform.
...
5.  Click **Add fields** and add the fields you want to store from the DevPlatform interview report (for example, candidate name, score, or test status). Refer to the [DevPlatform sample interview report](https://drive.google.com/file/d/1lB29Bmnr11Zve2DzGWPmGCAY2OKZp3I2/view?usp=sharing) to identify the available result fields. Select the appropriate field type for each field (for example, Text, Number, or Checkbox).

**Note:** Zapier Tables is one option to store interview results from DevPlatform. You can also store results in apps such as Google Sheets or Slack, depending on your workflow needs.

**Step 5: Complete a sample DevPlatform interview**
...
After you complete the interview, DevPlatform sends the interview results to Zapier for testing.

**Step 6: Complete Zap configuration to receive interview results**

Complete the Zap created in **Step 1** to store interview results from DevPlatform.
...
7.  In the **Test** section, click **Test step** to verify that DevPlatform sends the interview results to the **Interview results** table created in Step 4.

8.  Click **Publish**.

Your DevPlatform interview Zap automation is now complete.

# Sending interview invites

After you have configured the Zaps for DevPlatform interview, you can send interview invites to candidates.
...
5.  Enter values for the required and optional fields listed below.
    ...
    <td data-colspan="1" data-rowspan="1" data-colwidth="365" style="width: 365px"><p>Determines whether DevPlatform sends the interview invite email to the candidate. Select this checkbox to send the invite.</p></td>
    <td data-colspan="1" data-rowspan="1"><p>Optional</p>
    <p><br />
    </p></td>
    </tr>
    ...
    <td data-colspan="1" data-rowspan="1" data-colwidth="365" style="width: 365px"><p>Webhook URL that DevPlatform uses to send interview results to Zapier. Paste the webhook URL generated in <strong>Step 1</strong>.</p></td>
    <td data-colspan="1" data-rowspan="1"><p>Required</p>
    <p><br />
    </p></td>
    </tr>
...
Zapier sends DevPlatform interview invites to candidates based on the data you enter.
