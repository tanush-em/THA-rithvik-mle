---
title: "Zapier - DevPlatform Integration Guide Prerequisites Integrating Zapier with DevPlatform"
title_slug: "zapier-devplatform-integration-guide-prerequisites-integrating-zapier-with-devplatform"
source_url: "https://support.devplatform.com/articles/9883166979-zapier-devplatform-integration-guide"
article_slug: "9883166979-zapier-devplatform-integration-guide"
...
# Zapier - DevPlatform Integration Guide Prerequisites Integrating Zapier with DevPlatform

_Last updated: Jan 30, 2026, 12:26 PM (Last updated 3 months ago)_

The Zapier-DevPlatform integration lets you connect DevPlatform with Zapier to automate workflows between DevPlatform and other applications. 

This integration enables non-technical users to create no-code automations that sync DevPlatform events, such as assessments and interviews, with third-party tools such as Airtable.

# Prerequisites

Before you begin, ensure you meet the following requirements:

- You have admin access to your DevPlatform and Zapier accounts.

- Your organization has an active Enterprise plan with DevPlatform.

# Integrating Zapier with DevPlatform

To integrate Zapier with DevPlatform:

## Step 1: Generate an integration API token in DevPlatform

The integration [](https://support.devplatform.com/articles/1406188460-greenhouse---devplatform-integration-guide#glossary-11) API token allows Zapier to connect securely with your DevPlatform account.

1.  Log in to your DevPlatform account using your credentials.

2.  Go to **Settings \> Integrations \> Zapier \> Connect,** or open the [Zapier integration](https://www.devplatform.com/work/settings/integrations/zapier/configuration) page directly.
...
## Step 2: Add the DevPlatform API token in Zapier

This step authorizes Zapier to connect with your DevPlatform account.
...
4.  In the **Add new connection** dialog, search for **DevPlatform**, and then select it.
...
6.  In the **Connect an Account** window:
    ...
    1.  Paste the DevPlatform API token from Step 1 into the **DevPlatform API Token** field.

    2.  Enter the email address associated with your DevPlatform account into the **User Email** field.

7.  Click **Yes. Continue to DevPlatform**.

Your Zapier account is now integrated with DevPlatform.
...
**Note:** After you integrate DevPlatform with Zapier, refer to the following user guides to create workflows for DevPlatform assessments and interviews:

- [📄 Zapier - DevPlatform Integration Test User Guide](/articles/7100809601)
  \
- [📄 Zapier - DevPlatform Integration Interview User Guide](/articles/5179178131)
  \
