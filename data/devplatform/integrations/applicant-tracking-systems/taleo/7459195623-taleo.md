...
title: "Taleo"
title_slug: "taleo"
source_url: "https://support.devplatform.com/articles/7459195623-taleo"
...
This article guides you on DevPlatform's side of the integration. This article should be used in conjunction with the Oracle documentation.

**Note**: Currently, DevPlatform does not support onboarding new customers onto this integration.
...
As the first step of configuring your DevPlatform for Work assessment service, you must generate an API Key, which needs to be added to the Taleo Service Configuration.
...
An Assessment Suite is a combination of one or more tests and/or interviews. As part of your configuration, you will need to fetch a list of assessment suite IDs and names from your DevPlatform for Work account.
