---
title: "Workday - DevPlatform Interviews Configuration Guide"
title_slug: "workday-devplatform-interviews-configuration-guide"
source_url: "https://support.devplatform.com/articles/4722432610-workday---devplatform-interviews-configuration-guide"
article_slug: "4722432610-workday---devplatform-interviews-configuration-guide"
...
# Workday - DevPlatform Interviews Configuration Guide
...
1.  [Import the CLAR File into Workday Studio](https://support.devplatform.com/articles/4722432610-workday---devplatform-interviews-configuration-guide#import-the-clar-file-into-workday-studio-7)

2.  [Add a Connection in Workday](https://support.devplatform.com/articles/4722432610-workday---devplatform-interviews-configuration-guide#add-a-connection-in-workday-9)

3.  [Deploy the CLAR File to Workday Tenant Using Workday Studio](https://support.devplatform.com/articles/4722432610-workday---devplatform-interviews-configuration-guide#deploy-the-clar-file-to-workday-tenant-using-workday-studio-14)

### Import the CLAR File into Workday Studio

1.  On the Studio menu bar, select **File -\> Import.**

    1.  Select the CLAR file import wizard in the **Workday** folder. You can find the CLAR file at this [link](https://s3.amazonaws.com/downloads.devplatform.com/ats/DevPlatform_Interview_Integration.clar).
...
1.  **Integration System User Configuration:**
    ...
    - Name the account as “DevPlatform_Interview_Integration_User_Step1”.
    ...
    Follow the above steps and create an additional Integration System User named ‘DevPlatform_Interview_Integration_User_Step2’.
...
2.  **Create Integration System Security Groups (Unconstrained).**
    ...
    - Name the group as “ISSG_DevPlatform_Interview_Integration.
...
5.  **Assign ISU to the Integration System.**
    ...
    1.  Search for ‘intsys: DevPlatform_Interview_Integration_Step2” and click into the Integration System.

    2.  Using the Related Actions off of the integration, navigate to Workday **Account -\> Edit.**

    3.  Select your ISU named ‘DevPlatform_Interview_Integration_User_Step2’.

    4.  Repeat these steps for adding the other ISU for ‘DevPlatform_Interview_Integration_Step1’ Integration System.
...
6.  **Manage Authentication Policies for API Access**
    ...
    - Navigate to ‘Activate All Pending Authentication Policy Changes’ to activate your changes.
      ...
      **Note**: If this is not set up correctly, it might result in issues with DevPlatform making web service calls back to Workday. If there are issues with authentication, use the ‘Signons and Attempted Signons’ report to troubleshoot the failed sign-on attempt.

### Add DevPlatform-specific Fields to the Integration

**Note**: Refer to the [Configure the DevPlatform Settings](https://support.devplatform.com/articles/4722432610-workday---devplatform-interviews-configuration-guide#configure-the-devplatform-settings-page-39) section below in the document and complete the setup in DevPlatform to retrieve the access_token and Company ID needed in the following steps.

1.  **Search for the integration in the tenant by searching ‘intsys: DevPlatform_Interview_Integration_Step2’ in the search bar.**

- Add the ‘**Access Token**’ provided by DevPlatform to the ‘Access Token.’ Integration Attribute using the Related Actions of the Integration System (Integration System -\> Configure Integration Attributes).

- Add the ‘**Company ID’** provided by DevPlatform to the ‘Company ID’ Integration Attribute using the Related Actions off the DevPlatform_Interview_Integration_Step2 integration system and doing Integration System -\> Configure Integration Attributes.
...
1.  **Access the Register External OAuth Client task.**
    ...
    - Find and select your integration system named ‘DevPlatform_Interview_Integration_Step1’.

    - Enter these values provided by your DevPlatform contact:
...
1.  Select the integration system named ‘DevPlatform_Interview_Integration_Step1’ from the Web Conference Integration System prompt and save.
...
5.  **Set up Integration Step:**
    ...
    - Select your integration system (Integration System Name: DevPlatform_Interview_Integration_Step2) and Click **OK.**
...
## Configure the DevPlatform Settings Page
...
4.  Enter the Interview Rating IDs from Workday that should map to ‘Pass’ and ‘Fail’ on the DevPlatform Side.
...
**Note**: If you move tenants, provide updated credentials to the DevPlatform team.
