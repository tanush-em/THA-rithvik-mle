---
title: "Setting Up DevPlatform SSO with OneLogin"
title_slug: "setting-up-devplatform-sso-with-onelogin"
source_url: "https://support.devplatform.com/articles/6114369280-setting-up-devplatform-sso-with-onelogin"
article_slug: "6114369280-setting-up-devplatform-sso-with-onelogin"
...
# Setting Up DevPlatform SSO with OneLogin

_Last updated: Mar 25, 2026, 2:36 PM (Last updated 1 month ago)_

## Overview

Single Sign-On (SSO) on DevPlatform for Work can be configured using efficient and productive Identity providers such as OneLogin.

The OneLogin SSO portal ensures that only authorized users get access to sensitive data. Users have to enter only one set of credentials to access apps in the cloud and behind the firewall – through desktops, smartphones, and tablets. With SAML, OneLogin SSO proves helpful in securely logging users into DevPlatform for Work either through the OneLogin portal or over your corporate intranet.

This article is a quick guide about configuring SSO on DevPlatform with OneLogin. To know about SSO and its benefits, refer to the article[📄 Getting Started with Single Sign-On](/articles/4264962721).
...
- You have admin access to your DevPlatform and OneLogin accounts.

## Adding DevPlatform to OneLogin
...
2.  In the search bar, search for *DevPlatform for Work* and click **Add**. DevPlatform for Work is OneLogin verified and is now added to your list of applications.
...
4.  Configure the DevPlatform application with an appropriate display name, icons, and portal visibility.

5.  Click **Save** to confirm that DevPlatform has been added as an application.
...
## Configuring SSO on DevPlatform

In this step, you must enter a unique DevPlatform SSO Key.

1.  Access the Settings page of your DevPlatform for Work account.
...
3.  Click on the **More Action** drop-down and select **SAML Metadata.** This permits you to acquire the XML Metadata file that needs to be uploaded onto DevPlatform’s SSO Settings Portal.
...
6.  Sign in and confirm that you are taken back to DevPlatform.   
...
7.  Once SSO is enabled, all users within your organization will be redirected to the OneLogin sign-in page, when logging into their DevPlatform for Work account.
