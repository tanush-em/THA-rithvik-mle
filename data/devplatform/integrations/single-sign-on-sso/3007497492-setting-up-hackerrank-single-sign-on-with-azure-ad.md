---
title: "Setting up DevPlatform Single Sign-On with Azure AD"
title_slug: "setting-up-devplatform-single-sign-on-with-azure-ad"
source_url: "https://support.devplatform.com/articles/3007497492-setting-up-devplatform-single-sign-on-with-azure-ad"
article_slug: "3007497492-setting-up-devplatform-single-sign-on-with-azure-ad"
...
# Setting up DevPlatform Single Sign-On with Azure AD

_Last updated: Mar 25, 2026, 2:34 PM (Last updated 1 month ago)_

## Overview

SSO (Single Sign-on) on DevPlatform for Work can be configured using efficient and productive Identity providers such as Azure AD.

You can log in to DevPlatform through Azure AD. Create, update, and deactivate user accounts through SCIM 2.0.

## Prerequisites

- Your organization has an Enterprise plan with DevPlatform.

- Obtain your SSO Unique ID by referring to the [Getting Started with Single Sign-On](https://support.devplatform.com/hc/en-us/articles/360001546888-Getting-Started-with-Single-Sign-On)

- Replace the ID in the URLs below where you find: "YOURSSOUNIQUEID"

- Keep these URLs available for the setup.

  - Entity ID: [https://www.devplatform.com/x/api/v1/sso/saml/YOURSSOUNIQUEID/metadata](https://www.devplatform.com/x/api/v1/sso/saml/YOURSSOUNIQUEID/metadata)

  - ACS/Reply URL: [https://www.devplatform.com/x/api/v1/sso/saml/YOURSSOUNIQUEID/acs](https://www.devplatform.com/x/api/v1/sso/saml/YOURSSOUNIQUEID/acs)

  - Logout URL: [https://www.devplatform.com/x/api/v1/sso/saml/YOURSSOUNIQUEID/logout](https://www.devplatform.com/x/api/v1/sso/saml/YOURSSOUNIQUEID/logout)
...
- DevPlatform accepts only the user's email address. DevPlatform SSO fails if it receives anything other than an email address.
...
11. Upload the metadata file to DevPlatform.
...
- Copying the DevPlatform SSO Link from **Step 2**, and trying it in a private or incognito window.
