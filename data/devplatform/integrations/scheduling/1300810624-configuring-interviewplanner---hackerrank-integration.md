---
title: "Configuring InterviewPlanner - DevPlatform Integration"
title_slug: "configuring-interviewplanner-devplatform-integration"
source_url: "https://support.devplatform.com/articles/1300810624-configuring-interviewplanner---devplatform-integration"
article_slug: "1300810624-configuring-interviewplanner---devplatform-integration"
...
# Configuring InterviewPlanner - DevPlatform Integration

_Last updated: Dec 13, 2024, 5:22 PM (Last updated 1 year ago)_

## Overview

DevPlatform's Interviews integrate with InterviewPlanner to facilitate a seamless and efficient Candidate screening process for recruiters. As part of their interview workflow, InterviewPlanner users can directly send DevPlatform Interview invites to Candidates.\
\

This article provides you with detailed configuration steps on DevPlatform and InterviewPlanner.\
\
...
<li><p>Log in using the InterviewPlanner account which has the same email address as the <strong>DevPlatform for Work Company Admin</strong> user account. This is important for sending DevPlatform Interview invites and generating interview links in InterviewPlanner.</p></li>
</ul>
<p><em>Example: If the email address in DevPlatform for Work is </em>[jackpeters@devplatform.com,](mailto:jackpeters@devplatform.com,) <em>the InterviewPlanner user account must also include the same email address.</em></p>
<ul>
...
## Configuring InterviewPlanner Integration with DevPlatform

When configuring the InterviewPlanner integration with DevPlatform, the administrator generates an API key that the admin must keep a record of.
...
4.  In the Live Coding Type drop-down, select DevPlatform.
...
5.  Enter the API Key that you generated from DevPlatform.

6.  Click **Save.** The API Key is added and the InterviewPlanner integration with DevPlatform is completed.
