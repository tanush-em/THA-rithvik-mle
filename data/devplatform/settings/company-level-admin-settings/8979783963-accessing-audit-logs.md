...
source_url: "https://support.devplatform.com/articles/8979783963-accessing-audit-logs"
...
DevPlatform provides a comprehensive audit trail for all user events, allowing admins to quickly identify who made changes, what the changes were, and when they occurred. This feature ensures efficient and transparent data investigation.
...
- DevPlatform retains only the last three years of audit logs**.**

- Seeing **DevPlatform** in the audit log means that DevPlatform's customer support team acted on the customer's behalf.
