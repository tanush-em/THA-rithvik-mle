---
title: "Centralized Interview Settings Prerequisite Accessing centralized interview settings Available interview settings"
title_slug: "centralized-interview-settings-prerequisite-accessing-centralized-interview-settings-available-interview-settings"
source_url: "https://support.devplatform.com/articles/9244658640-configure-interview-settings"
article_slug: "9244658640-configure-interview-settings"
last_updated_exact: "Apr 22, 2026, 10:22 AM"
...
# Centralized Interview Settings Prerequisite Accessing centralized interview settings Available interview settings

_Last updated: Apr 22, 2026, 10:22 AM (Last updated 4 days ago)_
...
- **Interview Guidelines:** Customize or replace DevPlatform’s standard interview guidelines that candidates view before an interview.\
  ...
  ![Interview Guidlines.gif](https://assets.usepylon.com/e6a58e21-be80-4777-9eaf-f73beeee94d9%2F1760087178551-InterviewGuidlines.gif?Expires=253370764800&Signature=PT6SEMIYEK-Av8RVPCt1bjVXpXqPP5BjdIMJXbcGLEOpBE7dw47lkL1zzYfIaqQm7S6bimteAxOtkwYucxCH1kIQ~Gl8NtWwA30XoPS4~vxMIliPhCbd7ErwpV5bBtczhBqH5GY79iJoW37buW0q0Ae6LCOrohuo-FGEyQWcyxoAxvn57RNGHCKDNW~jGhA~Tt0aDkuaRJJTSslATolIx6PZxVT4mfWN8FQUHzWAhZEXQibpgQJtek5yITok7bsQTHpjuZLoygQvDZxABofSSlibiFv5DTyXdqlhEYHVq2xRtWA1IkI7xLbYr95FBDWjwz8vNmFZwMV63xeN-noauw__&Key-Pair-Id=K3NV4LZ47N8M46)

- **Self-Signup for Interviewers:** Allow interviewers without an account to sign up before starting an interview. For more information, see  [📄 Self-Signup for Interviewers](/articles/6028726783).

- **Virtual Lobby:** Enable a virtual lobby to create a waiting room for interviews. The virtual lobby allows you to:

  - Restrict candidates from entering until the interviewer permits.

  - Conduct multiple interviews with a candidate using a single link.

  - View the real-time status of attendees without joining the interview.

  To enable the virtual lobby, select the **Enable virtual lobby** checkbox.

  ![image.png](https://assets.usepylon.com/e6a58e21-be80-4777-9eaf-f73beeee94d9%2F1776344134676-image.png?Expires=253370764800&Signature=N82RqxMzEyvwYkcqXNB54G4b7smnLCREkwVXFLIvC5zYo5AoL0DmyWScIFVcoVTiJOM49dRjjWuIlT7X~j007EE0MVdXKC5ccee-vOkt84xH4hB7VBzRBZqRrTexyF2x3nLPkdeDNcfYWWhW~w7MIu5~gZQ594FZwNhpyJSRqrNNyNk-SiqV7AIJ56~32jIvOtc-h8lliHEihj4LoXVKBinDWScGRqCgIloMetPPn2uMj9OO4bjpfKuWxOFS2-J7ksT5poHPbEHOCzXiopQqE6AllcxhmOBvcnG-dALFIpH1TS0HEGCKeBPTvdFpI4XTB9STRPaWWbzG2IPHqfQnIg__&Key-Pair-Id=K3NV4LZ47N8M46)

  **Note**: By default, the virtual lobby will not be enabled for your account.

<!-- -->

- **DevPlatform Built-in A/V:** Interviewers and candidates can use DevPlatform’s built-in audio and video during interviews. This option is enabled by default. You can disable this option if you use external communication tools such as Zoom or Microsoft Teams.
...
- **Interview Integrity Signals:** The **Interview Integrity Signals** feature provides real-time alerts for suspicious activity during interviews. The Screen-to-Interview Identity Match verifies that the candidate who completed the screening test is the same individual attending the interview. For more information, see [📄 Interview Integrity Signals](/articles/5161582600) and [📄 Screen-to-Interview Identity Match](/articles/8605077096).
  ...
  **Note**: Screen-to-Interview Identity Match feature is part of the AI Add-on.
...
- **AI Assistant for Candidates:** Allow candidates to use AI-powered features such as Chat, Autocomplete, and Agent mode within the IDE. For more information, see [📄 AI-Assisted Interviews](/articles/5821380141). 
  ...
  **Note**: This feature is part of the AI Add-on. 
