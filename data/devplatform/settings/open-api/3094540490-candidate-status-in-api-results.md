...
source_url: "https://support.devplatform.com/articles/3094540490-candidate-status-in-api-results"
...
When you retrieve candidate data using the DevPlatform API, the JSON response includes two integer fields:
