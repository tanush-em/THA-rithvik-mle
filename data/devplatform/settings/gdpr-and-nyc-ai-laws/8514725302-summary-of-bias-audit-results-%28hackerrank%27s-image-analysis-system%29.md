---
title: "Summary of Bias Audit Results (DevPlatform's Image Analysis System)"
title_slug: "summary-of-bias-audit-results-devplatforms-image-analysis-system"
source_url: "https://support.devplatform.com/articles/8514725302-summary-of-bias-audit-results-%28devplatform%27s-image-analysis-system%29"
article_slug: "8514725302-summary-of-bias-audit-results-%28devplatform%27s-image-analysis-system%29"
...
# Summary of Bias Audit Results (DevPlatform's Image Analysis System)

_Last updated: Dec 13, 2024, 5:03 AM (Last updated 1 year ago)_

<img src="https://assets.usepylon.com/e6a58e21-be80-4777-9eaf-f73beeee94d9%2F1734046436315-?Expires=253370764800&amp;Signature=b8XmwderVpN4GiT-AeNr7t0rZ9Vi7x0KzwpXiU-f0iZZrZWVyjaFgyd2IWCmm6URBFo2ZVlf9uxYK3tth~D9G4fWN-MVyuswXsdsAoXaVHuUV6~LmfZYG9u~akbRvtTqwOYp2Xc~vq~DI3ryV-X5QOpIH7huiySGGS8N2eId44tYdMJoGaspZePsM~sAvD01OfkbwDBpIwy2eMGNnp9k2X6107L410tzxNiRlsWqzdwmUrWeoaMIJCeOBGuYLYpDUJ8ra3sk68rHzVhRDn95CtAAxnAprbPjAX4lIzNUqB9umHW3tZAB94t2z0qVkmLtgYozRmgmxDxak-7pOT9PHg__&amp;Key-Pair-Id=K3NV4LZ47N8M46" class="kb-image block" data-drag-handle="false" />
...
To: **Interviewstreet Incorporation (DevPlatform)**

      PO Box 1660\
      211 Hope Street\
      Mountain View, California 94041

Re: **Audit Opinion on DevPlatform’s Image Analysis System 07/22/2024**

We have independently audited the bias testing assertions and related documentary evidence of DevPlatform (the "Company") as of 07/22/2024, presented to BABL AI in relation to Company’s Image Analysis System in accordance with the criteria and audit methodology set forth in this report. The goals of this audit are to:
...
We emphasize several matters related to the dataset sourced by DevPlatform to test for disparate impact: 1) self-declared demographic labels were not available from the historical use of the system, so publicly available “Test Data”, (see [§ 5-300](https://rules.cityofnewyork.us/wp-content/uploads/2023/04/DCWP-NOA-for-Use-of-Automated-Employment-Decisionmaking-Tools-2.pdf)), was used to assess the system for bias, and 2) the amount and quality of the testing dataset (see Findings) were limited. Consequently, the conclusions drawn from the disparate impact quantification are subject to the limitations arising from the dataset and should be interpreted in light of this constraint. Our opinion is not modified with respect to this matter.

## System Description

BABL AI was engaged to audit **DevPlatform**’s **Image Analysis System (**the system). The system periodically captures a number of webcam images of job candidates throughout an assessment, and processes them to reportedly detect the presence of suspicious activities from the candidates, such as by hiding themselves, or getting unauthorized help from others. For an assessment session, the system has three modes of detection:

1.  No-face: zero face is detected in a 90% of the total captured images;

2.  Multi-face: two or more faces are detected in at least one of the captured images; and

3.  Secondary-face: two or more *unique* faces are detected at various times during the session.

The system provides a report from these modes of detection and displays it to the users. Recruiters and hiring managers can then review the captured images to verify the presence of cheating, and decide whether to move a candidate forward.

The rates of candidates not being ﬂagged by the system are to be used as selection rates for candidates that belong to various demographic groups. Note that the selection rates of only the no-face detection mode are displayed on p. 14 in the [Findings](https://docs.google.com/document/d/152psYl9nKAyDpPdf7Ix7DmqGUHNjYk7xhSpGNvm6ogU/edit?pli=1#heading=h.lnxbz9) section, as no-face is the primary detection mode of the system and its non-ﬂagging rate is equivalent to that at the system level.
...
BABL AI is also responsible for maintaining auditors’ independence and objectivity to ensure the integrity of the opinion and certification provided. BABL AI as an organization, and all employee and contract auditors, adhere to strict independence as codified by the Sarbanes–Oxley Act of 20023 and the ForHumanity’s Code of Ethics.4 In addition, BABL AI Lead Auditors are ForHumanity Certified Auditors under NYC AEDT Bias Audit.5 For more details about our methodology and process, see Appendix – Audit Methodology.
...
- [https://www.iaasb.org/publications/international-standard-assurance-engagements-isae-3000-revised-assurance-engagements-other-audits-or-0](https://www.iaasb.org/publications/international-standard-assurance-engagements-isae-3000-revised-assurance-engagements-other-audits-or-0)
...
- [https://www.govinfo.gov/content/pkg/PLAW-107publ204/pdf/PLAW-107publ204.pdf](https://www.govinfo.gov/content/pkg/PLAW-107publ204/pdf/PLAW-107publ204.pdf)

- [https://forhumanity.center/code-of-ethics/](https://forhumanity.center/code-of-ethics/)

- [https://forhumanity.center/nyc-bias-audit/](https://forhumanity.center/nyc-bias-audit/)

### Conclusions

Our opinions for the bias audit of DevPlatforms Image Analysis System are as follows:
...
<tbody>
<tr>
<td data-colspan="1" data-rowspan="1" style="width: 69.6413%; background-color: #6fa8dc"><p><strong>Audit Section</strong></p></td>
<td data-colspan="1" data-rowspan="1" style="width: 89.6447%; background-color: #6fa8dc"><p><strong>Opinion</strong></p></td>
</tr>
<tr>
<td data-colspan="1" data-rowspan="1" style="width: 69.6413%"><p>Q.A. Components: The model to be tested for disparate impact shall be defined.</p>
<ul>
<li><p>Q.A.1. Where the model comprises more than one automated component, evidence shall show appropriate definition of the model.</p></li>
</ul></td>
...
<tbody>
<tr>
<td data-colspan="1" data-rowspan="1" style="width: 69.7373%; height: 311px"><p><strong>Q.B. Testing dataset:</strong> The dataset on which disparate impact was quantified shall be defined and characterized.</p>
<ul>
...
<li><p>b. that historical data is not sufficient to perform a statistically significant disparate impact testing, and</p></li>
<li><p>c. the methodology by which test data was collected</p></li>
</ul></li>
</ul>
<ul>
<li><p>Q.B.3. Where disparate impact testing was not completed by BABL, evidence shall show</p></li>
</ul>
<ol>
<li><p>a. that the most recent testing was conducted less than one year prior to the start date of this audit, or after a major update to the model, unless the update was more than one year prior to the start date of this audit, in which case, evidence shall show</p>
<ol>
...
<td data-colspan="1" data-rowspan="1" style="text-align: center; width: 89.5484%; vertical-align: middle; height: 311px;"><p><strong>PASS</strong></p></td>
</tr>
</tbody>
</table>
...
**Testing conducted by**: DevPlatform

**Date of last testing**: Jun 2024\
**Time span of data**: N/A, “Test Data” was used for the analysis.

**Justification for the use of Test Data**: From DevPlatform: “\[We used\] public datasets for disparate impact testing, as DevPlatform has insufficient data to build an unbiased dataset.”

**Description of the dataset**: From DevPlatform: “... \[we used\] a public dataset, the FairFace dataset. FairFace is a face image dataset which is race balanced. It contains 108,501 images from 7 different race groups. Images were collected from the YFCC-100M Flickr dataset and labeled with race, gender. This dataset defines 7 race groups: White, Black, Indian, East Asian, Southeast Asian, Middle Eastern, and Latino, and 2 genders: Male and Female. We selected this dataset because: a) it’s balanced on race, b) it achieved the highest accuracy among many other dataset, c) it’s manually labeled from 3 different people for each image.

We have used 100 images per category which we randomly sampled for testing this case. The assumption behind random sampling is that every individual or element in the population has

an equal and independent chance of being selected for the sample. In other words, no systematic bias or preference is applied when selecting the sample.”
...
Due to limitations in the testing dataset, the race/ethicity categories are White, Black, Indian, East Asian, Southeast Asian, Middle Eastern, and Latino..
...
**Positive outcome**: A candidate not being ﬂagged by the system.
...
**Method of quantifying disparate impact**: The selection rate is defined by the number of images in the category not flagged by the model divided by the total number of images in the category. Note that this estimate is an extreme lower limit, as an actual flag (see “positive outcome” above) only happens after multiple images taken during the assessment are flagged in the ways described above. Also, note that “No face” (see System Description) was the dominant flag in the testing results.
...
|        |           |                |              |
|--------|-----------|----------------|--------------|
|        | N samples | Selection rate | Impact ratio |
| Male   | 14000     | 1.000          | 1.000        |
| Female | 14000     | 1.000          | 1.000        |
...
|---------------------------|-----------|----------------|--------------|
|                           | N samples | Selection rate | Impact ratio |
| Black or African American | 4,000     | 1.000          | 1.000        |
| Asian                     | 16,000    | 1.000          | 1.000        |
| Hispanic or Latino        | 4,000     | 1.000          | 1.000        |
| White                     | 4,000     | 1.000          | 1.000        |
...
<tbody>
<tr>
<td data-colspan="1" data-rowspan="1" style="width: 11.7384%; height: 22px; background-color: #6fa8dc"><p> </p></td>
<td data-colspan="1" data-rowspan="1" style="width: 10.2151%; height: 22px; background-color: #6fa8dc"><p> </p></td>
<td data-colspan="1" data-rowspan="1" style="width: 12.0968%; height: 22px; background-color: #6fa8dc"><p> </p></td>
<td data-colspan="1" data-rowspan="1" style="width: 22.2321%; height: 22px; background-color: #6fa8dc"><p>N samples</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 22.7562%; height: 22px; background-color: #6fa8dc"><p>Selection rate</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 70.8224%; height: 22px; background-color: #6fa8dc"><p>Impact ratio</p></td>
</tr>
<tr>
<td data-colspan="1" data-rowspan="1" style="width: 11.7384%; height: 44px"><p>Hispanic or Latino</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 22.3119%; height: 22px"><p>Male</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 22.2321%; height: 22px"><p>2000</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 22.7562%; height: 22px"><p>1.000</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 70.8224%; height: 22px"><p>1.000</p></td>
<td data-colspan="1" data-rowspan="1"><p><br />
</p></td>
</tr>
<tr>
<td data-colspan="1" data-rowspan="1" style="width: 22.3119%; height: 22px"><p>Female</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 22.2321%; height: 22px"><p>2000</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 22.7562%; height: 22px"><p>1.000</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 70.8224%; height: 22px"><p>1.000</p></td>
<td data-colspan="1" data-rowspan="1"><p><br />
...
<tr>
<td data-colspan="1" data-rowspan="1" style="text-align: center; width: 11.7384%; height: 355px; vertical-align: middle;"><p>Non- Hispanic or Latino</p>
<p><br />
<br />
</p>
<p> </p>
...
<p> </p>
<p> </p></td>
<td data-colspan="1" data-rowspan="1" style="width: 10.2151%; height: 198px"><p>Male</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 12.0968%; height: 22px"><p>White</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 22.2321%; height: 22px"><p>2000</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 22.7562%; height: 22px"><p>1.000</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 70.8224%; height: 22px"><p>1.000</p></td>
</tr>
<tr>
<td data-colspan="1" data-rowspan="1" style="width: 12.0968%; height: 22px"><p>Asian</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 22.2321%; height: 22px"><p>8000</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 22.7562%; height: 22px"><p>1.000</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 70.8224%; height: 22px"><p>1.000</p></td>
<td data-colspan="1" data-rowspan="1"><p><br />
</p></td>
...
<tr>
<td data-colspan="1" data-rowspan="1" style="width: 12.0968%; height: 44px"><p>Black or African American</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 22.2321%; height: 44px"><p>2000</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 22.7562%; height: 44px"><p>1.000</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 70.8224%; height: 44px"><p>1.000</p></td>
<td data-colspan="1" data-rowspan="1"><p><br />
</p></td>
<td data-colspan="1" data-rowspan="1"><p><br />
</p></td>
...
<tr>
<td data-colspan="1" data-rowspan="1" style="width: 10.2151%; height: 157px"><p>Female</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 12.0968%; height: 22px"><p>White</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 22.2321%; height: 22px"><p>2000</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 22.7562%; height: 22px"><p>1.000</p></td>
<td data-colspan="1" data-rowspan="1" style="width: 70.8224%; height: 22px"><p>1.000</p></td>
...
<tbody>
<tr>
<td data-colspan="1" data-rowspan="1" style="width: 69.2825%"><p><strong>Q.H. Statistical significance</strong>: Where the selection rate method was used, statistical significance calculation shall satisfy UGESP guidelines.</p>
...
**Contact information**: [abhilash@devplatform.com](mailto:abhilash@devplatform.com)\
...
3.  **Verify that the claims and statements** made by the auditee are free from material misstatement, whether due to fraud or error.8

7 Carrier, R., & Brown, S. (2021). Taxonomy: AI Audit, Assurance & Assessment. ForHumanity.
...
8 “Reasonable assurance” is a high level of assurance but is not a guarantee that an audit conducted in accordance with good auditing practice always detects a material misstatement when it exists. Misstatements can arise from fraud or error and are considered material if, individually or in aggregate, they could reasonably be expected to influence the decisions of stakeholders taken based on these statements.
...
| impact ratio |   | “either (1) the selection rate for a category divided by the selection rate of the most selected category or (2) the scoring rate for a category divided by the scoring rate for the highest scoring category. ” – see § 5-300 of the adopted rule for full definition |
...
9 Hasan, A., Brown, S., Davidovic, J., Lange, B., & Regan, M. (2022). Algorithmic Bias and Risk Assessments: Lessons from Practice. Digital Society, 1(1). [https://doi.org/10.1007/s44206-022-00017-z](https://doi.org/10.1007/s44206-022-00017-z)
