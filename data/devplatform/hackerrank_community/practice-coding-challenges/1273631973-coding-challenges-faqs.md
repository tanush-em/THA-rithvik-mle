...
source_url: "https://help.devplatform.com/articles/1273631973-coding-challenges-faqs"
...
Refer to the [Scoring](https://www.devplatform.com/scoring) Documentation.
...
3.  Confirm you are using the correct account. Log in to the **same DevPlatform Community account** you used to participate in the challenge. Results do not appear across different accounts.

4.  Contact DevPlatform support at [help@devplatform.com](mailto:help@devplatform.com) if you are still facing an issue with challenge results.

**Note:** If you take part in a company-sponsored challenge, DevPlatform does not display the results. The company that hosts the challenge contacts you directly with the results or next steps.
