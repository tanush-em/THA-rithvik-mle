...
title_slug: "introduction-to-certification"
source_url: "https://help.devplatform.com/articles/2563639100-introduction-to-certification"
article_slug: "2563639100-introduction-to-certification"
last_updated_exact: "Nov 18, 2025, 6:56 PM"
...
_Last updated: Nov 18, 2025, 6:56 PM (Last updated 5 months ago)_

DevPlatform certifications are free, timed assessments that allow developers to demonstrate their technical skills to potential employers. These certifications validate proficiency in high-demand skills, such as Python, JavaScript, and React, and job roles, such as software engineer and front-end developer.

## Types of certifications

DevPlatform offers two types of certifications:

- [Skill-based certifications](https://devplatform-community-knowledge-base.help.usepylon.com/articles/2563639100-introduction-to-certification#role-based-certification-34)

- [Role-based certifications](https://devplatform-community-knowledge-base.help.usepylon.com/articles/2563639100-introduction-to-certification#role-based-certification-33)
...
Skill-based certifications evaluate expertise in a specific skill. DevPlatform offers 21 technical skill certifications that range from universal competencies, such as problem-solving, to specialized skills, such as Java or Python. The following list shows all 21 skill-based certifications and the respective concepts assessed in each certification test:
...
Role-based certifications evaluate multiple related skills to assess readiness for a specific job role. DevPlatform offers the following role-based certifications and evaluates the respective skills for each role:
